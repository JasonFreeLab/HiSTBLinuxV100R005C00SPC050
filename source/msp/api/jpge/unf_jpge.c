...
* others:       : NA
****************************************************************************/
HI_S32 JPGE_FreeMem(HI_U32 u32PhyAddr)
{
...
* others:       : NA
****************************************************************************/
HI_U32 JPGE_AllocMem(HI_U32 u32Size, HI_U32 u32Align,HI_CHAR *pName)
{
    HI_U32 u32PhyAddr = 0;
...
* others:       : NA
****************************************************************************/
HI_VOID *JPGE_Map(HI_U32 u32PhyAddr)
{
    if (0 == u32PhyAddr)
    {
        return NULL;
...
* others:       : NA
****************************************************************************/
HI_S32 JPGE_Unmap(HI_U32 u32PhyAddr)
{
    if (0 == u32PhyAddr)
    {
        return HI_FAILURE;
