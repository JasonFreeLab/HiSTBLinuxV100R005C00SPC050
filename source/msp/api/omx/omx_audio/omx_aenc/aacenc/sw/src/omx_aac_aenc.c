        ...
        OMX_INOUT OMX_PTR     pParamStructure)
{
    ...
    switch (nParamIndex)
    {
        ...
        case OMX_IndexParamAudioAac:
            ...
            memcpy(pParamStructure, (OMX_AUDIO_PARAM_AACPROFILETYPE*)pHAData->pCodecParam,
        ...
        OMX_IN OMX_PTR        pParamStructure)
{
    ...
    switch (nIndex)
    {
        ...
        case OMX_IndexParamPortDefinition:
            ...
            {
                memcpy(&pHAData->sInPortDef, pParamStructure, sizeof
                       (OMX_PARAM_PORTDEFINITIONTYPE));
            }
            else if (((OMX_PARAM_PORTDEFINITIONTYPE*)
                      (pParamStructure))->nPortIndex == pHAData->sOutPortDef.nPortIndex)
            {
                memcpy(&pHAData->sOutPortDef, pParamStructure, sizeof
                       (OMX_PARAM_PORTDEFINITIONTYPE));
            }
            else
            {
        ...
        case OMX_IndexParamAudioAac:
            ...
            OMX_OSAL_Trace(OMX_OSAL_TRACE_DEBUG, "%s -> OMX_IndexParamAudioAac\n", __FUNCTION__);
            memcpy((OMX_AUDIO_PARAM_AACPROFILETYPE*)pHAData->pCodecParam, pParamStructure,
                   sizeof(OMX_AUDIO_PARAM_AACPROFILETYPE));
            break;
