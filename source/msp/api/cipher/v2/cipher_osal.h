...
#define cipher_mutex                 pthread_mutex_t
#define cipher_mutex_init(x)         (void)pthread_mutex_init(x, NULL)
#define cipher_mutex_lock(x)         (void)pthread_mutex_lock(x)
#define cipher_mutex_unlock(x)       (void)pthread_mutex_unlock(x)
#define cipher_mutex_destroy(x)      pthread_mutex_destroy(x)

#define cipher_open(a, b, c)         open(a, b, c);
#define cipher_close(x)              close(x)
#define cipher_ioctl(dev, cmd, argp) ioctl(dev, cmd, argp)
