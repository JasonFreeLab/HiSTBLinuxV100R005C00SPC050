...
#define HI_ERR_PVR_PLAY_CHANGE_PID          ((HI_U32)(-3))      //标志应该切换Pid
...
typedef struct hiPVR_INDEXER_S
{
    ...
    PVR_RECORD_LAST_INFO_S stAppendRecLastRecordInfo;       /*CNcomment:记录追加录制时上次录制的相关信息*/
#endif
#ifdef PVR_PID_CHANGE_SUPPORT
...
HI_S32 PVR_Index_RecAlignTheLastPidInfoWhenChangePid(PVR_INDEX_HANDLE handle, HI_CHAR *pszFileName, PVR_INDEX_PID_INFO_S *pLastPidInfo);
...
#if defined(PVR_APPEND_MODE_SUPPORT) && defined(PVR_PID_CHANGE_SUPPORT)
HI_S32 PVR_Index_RecReviseThePidCtrlInfoWhenAppendRecord(PVR_INDEX_HANDLE handle, HI_U32 u32LastRecValidEndFrm, PVR_RECORD_LAST_INFO_S *pstLastRecInfo);
#endif
#if 0  /*obsolete APIs*/
