...
typedef struct hiPVR_PLAY_CHN_S
{
    ...
    PVR_PID_CHANGE_CALLBACK_S   stPlayPidChangeCB;                       /**<the callback function was called when pid changed.*//**<CNcomment: Pid���ʱ�Ĳ��Żص�����*/
    HI_BOOL                 bChangePID;             /*�жϵ�ǰ����ͨ��״̬�Ƿ�Ϊ�����л�PID*/
} PVR_PLAY_CHN_S;
