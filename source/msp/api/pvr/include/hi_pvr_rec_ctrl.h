...
typedef struct hiPVR_REC_CHN_S
{
    ...
    PVR_RECORD_LAST_INFO_S stLastRecInfo;           /* Records the information about the recording of the last time */
#endif
    PVR_EXTEND_CALLBACK_S  stRecCallback;
    PVR_PID_CHANGE_CALLBACK_S   stRecPidChangeCB;                       /**<the callback function was called when pid changed.*//**<CNcomment: Pid变更时的播放回调函数*/
#ifdef HI_TEE_PVR_SUPPORT
