                                            ...
                                            HI_U32 u32CipherHead, HI_U32 u32CipherEnd, HI_U32 u32HeadToAdd, HI_U32 u32EndToAdd)
{
    ...
    if ((HI_SUCCESS == ret) && ((stPrevFrame.stEntry2.u64GlobalOffset + stPrevFrame.stEntry2.u32FrameSize) != u64GlobalOffset))
    {
        PVRPlaySetTsHead(pu8Data + u32CipherHead, u32HeadToAdd);
        HI_WARN_PVR("  ------------------------------ curFrameNum = %lu\n",u32CurFrameNum);
        bIsBoundary = HI_TRUE;
    }
    else
    {
        ret = PVR_Index_GetFrameByNum(IndexHandle, &stNextFrame, u32CurFrameNum + 1);
        if ((HI_SUCCESS == ret) && ((u64GlobalOffset + u32CurFrameSize) != stNextFrame.stEntry2.u64GlobalOffset))
        {
...
HI_S32 PVRPlayProcessFirstFrameDisplay(HI_HANDLE hAvplay, HI_UNF_AVPLAY_EVENT_E enEvent, HI_VOID* pPara)
{
    HI_U32 i = 0;
    PVR_PLAY_CHN_S* pChnAttr = (PVR_PLAY_CHN_S*)HI_NULL;
...
#ifdef PVR_PID_CHANGE_SUPPORT
/*CNcomment: �ط�ʱPID�����ı䣬Ϊ��֤�ٶ�ʧ���ݣ���Ҫ�ȴ��ϸ�PID���������ĵ�һ��ˮ��ʱ���л���
                    ������ȴ������лὫͨ������bChangePID��ΪHI_TRUE������seek��pause��resume��������ˣ���֡���ŵȲ���ʱ
                    ����HI_ERR_PVR_NOT_SUPPORT��֧��stopͨ��*/
static HI_S32 PVRPlayWaitCurrentDataConsume(PVR_PLAY_CHN_S *pChnAttr)
{
    ...
    HI_U32 u32TimeOutMinMs = 1 * 1000; //�ȴ�ʱ�����С����
