...
HI_S32 DRV_CA_OTP_V200_SetMiscKlLevel(HI_UNF_ADVCA_KEYLADDER_LEV_E enLevel)
{
    ...
    if((0x01 == PVLOCK_1.bits.misc_lv_sel_2_lock) && (PV_1.bits.misc_lv_sel_2 != PV_1.bits.misc_lv_sel_2))
    {
...
static DRV_ADVCA_OTP_FUSE_FUNC_MAP_S g_astSetOtpFuseFuncMap[] =
{
    ...
    {HI_UNF_ADVCA_OTP_SOS_MARKET_SEGMENT_ID,             DRV_CA_OTP_V200_SetOtpFuse_SOS_MARKET_SEGMENT_ID},
};
...
static DRV_ADVCA_OTP_FUSE_FUNC_MAP_S g_astGetOtpFuseFuncMap[] =
{
    ...
    {HI_UNF_ADVCA_OTP_SOS_MARKET_SEGMENT_ID,             DRV_CA_OTP_V200_GetOtpFuse_SOS_MARKET_SEGMENT_ID},
};
