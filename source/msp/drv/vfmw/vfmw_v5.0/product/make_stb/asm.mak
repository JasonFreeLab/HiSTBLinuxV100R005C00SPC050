...
ASM_CFLAGS += -DCHIP_TYPE_hi3798mv200 -DCHIP_TYPE_hi3798mv300 -DCHIP_TYPE_hi3798mv200_a
endif
...
OPEN_SRC += $(VFMW_BASE)/module/svdec/vfmw_svdec_intf.S $(VFMW_BASE)/module/hdr_info/hdr_info.S $(VFMW_BASE)/module/pts_info/pts_info.S $(VFMW_BASE)/module/pts_info/frd_alg.S
