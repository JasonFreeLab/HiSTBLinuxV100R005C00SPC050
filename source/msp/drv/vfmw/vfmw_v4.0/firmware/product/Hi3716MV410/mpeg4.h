...
#define    SH_THRESHOLD                   18          // ShortHeader头标识计数//modify from 8 to 18,Because we found 13 Short Header in X-Men stream.
...
#define    HISI_MP4_STREAM_END_CODE       0x000001b600008000     // for bvt sdk

// 这个值不能随便修改，如要修改需要同时改scd过滤头及PTS检测新帧seg两处地方
#define    HISI_STREAM_END_CODE           0x000001fe             // for eos sdk
