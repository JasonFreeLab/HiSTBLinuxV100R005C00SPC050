...
#define    HEVC_CA_MN_ADDR_LEN                       (1024)         //sdk  20141016   H265协议CA_MN可减为1K
#define HEVC_ONEMB_PMV_COLMB_ADDR_LEN                (260*14)
#define HEVC_UPMSG_ADDR_LEN                          (4*4*HEVC_MAX_SLICE_NUM)       //sdk  20141016   跟逻辑确认过
#define HEVC_PPFD_BUFFER_LEN                         (64*4*800)                      //8192 words
#define HEVC_TILE_SEGMENT_INFO_LEN                	 (2048)     //(512*2+20*4+22*4=1192, 1024对齐)  sdk  20141024
...
#define HEVC_MAX_SLOT_NUM                                (HEVC_MAX_SLICE_NUM+5)        //sdk  20141025    为BVT省内存
#else
#define HEVC_MAX_SLOT_NUM                                (HEVC_MAX_SLICE_NUM+10)        //sdk  20141025
#endif
...
typedef struct
{
    ...
    UINT8  TileId[2][HEVC_MAX_CTB_NUM_PER_LINE];//sdk  2014102
