...
#define   SCALABLE_BASELINE_PROFILE           83       //add by sdk for svc base profile
#define   SCALABLE_HIGH_PROFILE               86       //add by sdk for svc high profile
