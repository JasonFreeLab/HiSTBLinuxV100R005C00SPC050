...
#define    IMEDIA_AVC_INV_INBUFF               (-17)   // 输入缓冲区为空
#define    IMEDIA_AVC_INV_MEM_ODD              (-18)   // 无效的奇地址
#define    IMEDIA_AVC_INV_OUTBUFF              (-19)   // 输出缓冲区为空
#define    IMEDIA_AVC_INV_OUTBUFF_UNALIGNED    (-20)   // 输出缓冲区地址没有4字节对齐
#define    IMEDIA_AVC_UNINITIED                (-21)   // 没有完成初始化
#define    IMEDIA_AVC_INV_PARA_VERSION         (-22)   // 无效版本信息结构体指针
