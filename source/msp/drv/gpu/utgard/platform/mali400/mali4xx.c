...
#define HISI_GPU_RESOURCES_MALI400_MP2_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq) \
	MALI_GPU_RESOURCE_PMU(base_addr + 0x2000) \
	MALI_GPU_RESOURCE_L2(base_addr + MALI400_OFFSET_L2_CACHE0) \
	MALI_GPU_RESOURCE_GP_WITH_MMU(base_addr + MALI_OFFSET_GP, gp_irq, base_addr + MALI_OFFSET_GP_MMU, gp_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(0, base_addr + MALI_OFFSET_PP0, pp0_irq, base_addr + MALI_OFFSET_PP0_MMU, pp0_mmu_irq) \
...
#define HISI_GPU_RESOURCES_MALI400_MP1_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq) \
	MALI_GPU_RESOURCE_PMU(base_addr + 0x2000) \
	MALI_GPU_RESOURCE_L2(base_addr + MALI400_OFFSET_L2_CACHE0) \
	MALI_GPU_RESOURCE_GP_WITH_MMU(base_addr + MALI_OFFSET_GP, gp_irq, base_addr + MALI_OFFSET_GP_MMU, gp_mmu_irq) \
	MALI_GPU_RESOURCE_PP_WITH_MMU(0, base_addr + MALI_OFFSET_PP0, pp0_irq, base_addr + MALI_OFFSET_PP0_MMU, pp0_mmu_irq)
...
static struct mali_gpu_device_data mali_gpu_data =
{
    ...
    .max_job_runtime      = 5000, /* 60 seconds */
...
int mali_platform_device_register(void)
{
    ...
    {
#if defined (CHIP_TYPE_hi3716mv400) || defined (CHIP_TYPE_hi3716mv420) || defined (CHIP_TYPE_hi3716mv410)
    	HISI_GPU_RESOURCES_MALI400_MP1_PMU(MALI_BASE_ADDRESS, GP_IRQ,  GP_MMU_IRQ, PP0_IRQ, PP0_MMU_IRQ)
#elif defined (CHIP_TYPE_hi3719mv100) || defined (CHIP_TYPE_hi3718mv100)
    	HISI_GPU_RESOURCES_MALI400_MP2_PMU(MALI_BASE_ADDRESS, GP_IRQ,  GP_MMU_IRQ, PP0_IRQ, PP0_MMU_IRQ, PP1_IRQ, PP1_MMU_IRQ)
#else
    	HISI_GPU_RESOURCES_MALI400_MP4_PMU(MALI_BASE_ADDRESS, GP_IRQ,  GP_MMU_IRQ, PP0_IRQ, PP0_MMU_IRQ, PP1_IRQ, PP1_MMU_IRQ, PP2_IRQ, PP2_MMU_IRQ, PP3_IRQ, PP3_MMU_IRQ )
#endif
    };
