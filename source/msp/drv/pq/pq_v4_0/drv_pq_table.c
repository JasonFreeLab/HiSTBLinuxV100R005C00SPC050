...
HI_VOID pq_table_ProcessInitSoftTable(HI_U32 u32Addr, HI_U32 u32Value)
{
    ...
    switch (u32Addr)
    {
        ...
        case PQ_SOFT_MODULE_VDP4KSNR_SD:
            PQ_COMM_SetMoudleCtrl(HI_PQ_MODULE_VDP4KSNR, SOURCE_MODE_SD, u8Value);
            break;
        case PQ_SOFT_MODULE_VDP4KSNR_FHD:
            PQ_COMM_SetMoudleCtrl(HI_PQ_MODULE_VDP4KSNR, SOURCE_MODE_HD, u8Value);
            break;
        case PQ_SOFT_MODULE_VDP4KSNR_UHD:
            PQ_COMM_SetMoudleCtrl(HI_PQ_MODULE_VDP4KSNR, SOURCE_MODE_UHD, u8Value);
            break;
