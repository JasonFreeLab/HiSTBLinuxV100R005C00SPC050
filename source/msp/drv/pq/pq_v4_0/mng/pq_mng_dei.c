...
HI_S32 PQ_MNG_DEI_ParaInit(HI_VOID)
{
    ...
    /*stDeiPara->u32StartMotionIIRRatio 1~4 ��Ҫ��������*/
    ...
    /*au16FrmFldBlendRatio[0]���úã�1 2 3 4��Ҫ��������*/
...
/*****************************************************************************
 Prototype    : DI_SW_ALG
 Description  : DI���㷨
 Input        : Parm_s * pstMcParm         :MCDI�Ĳ���
                DeiVariables_S * pstDeiVar :MADI�Ĳ���
                DeiSwAlgCfg_S * pstDeiSwAlgPara :���㷨����
