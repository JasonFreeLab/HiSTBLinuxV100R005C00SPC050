...
#define  PQ_MODIFY_TIME     "(20170721)"
...
static HI_S32 drv_pq_ProcSetPrintHdrTm(HI_CHAR *pArg1, HI_CHAR *pArg2);
...
static PQ_PROC_FUN_S g_stPQProcInfo[] =
{
    ...
    {"printhdrtm",   drv_pq_ProcSetPrintHdrTm},
...
HI_S32 DRV_PQ_ProcRead(struct seq_file *s, HI_VOID *data)
{
    ...
    HI_U8 *au8ProcSourceType[SOURCE_MODE_ALL] =
    {
        "Unknown",
        "SD",
        "HD",
    ...
    HI_U8 *au8ProcVPMode[HI_DRV_PQ_VIDEOPHONE_MODE_BUTT] =
    {
        ...
        "HI_DRV_PQ_VIDEOPHONE_MODE_BLUE",
        "HI_DRV_PQ_VIDEOPHONE_MODE_GREEN",
        "HI_DRV_PQ_VIDEOPHONE_MODE_BG",
        "HI_DRV_PQ_VIDEOPHONE_MODE_ORIGINAL",
        "HI_DRV_PQ_VIDEOPHONE_MODE_FUN",
    ...
    PROC_PRINT(s, "%-20s: %-20s\n", "Video phone mode", (PQ_IMAGE_MODE_VIDEOPHONE == g_stPqStatus.enImageMode) ? "yes" : "no");
...
static HI_VOID DRV_PQ_ProcPrintHelp(HI_VOID)
{
    ...
    HI_DRV_PROC_EchoHelper("echo hdroffset       bbccsshhrrggbb   > /proc/msp/pq\n");
    HI_DRV_PROC_EchoHelper("echo hdrtm           M(0-1)DD(AccD:0-99)BB(AccB:0-99)dd(0-99)bb(0-99) > /proc/msp/pq\n");
    ...
    HI_DRV_PROC_EchoHelper("echo sharp/dci/acm/tnr/snr/dei/db/vpscene/vdp4ksnr/all   demoon/demooff  > /proc/msp/pq\n");
    HI_DRV_PROC_EchoHelper("\n");
#endif
}
...
{
    HI_U32 u32Data = (HI_U32)simple_strtol(pArg2, NULL, 10);
    if (PQ_FUNC_CALL(HI_PQ_MODULE_HDR,GetHdrPqTm))
    {
        GET_ALG_FUN(HI_PQ_MODULE_HDR)->GetHdrPqTm(u32Data);
    }
    return HI_SUCCESS;
}
...
static HI_S32 drv_pq_ProcSetHdrOffset(HI_CHAR *pArg1, HI_CHAR *pArg2)
{
    ...
    if (GET_ALG(HI_PQ_MODULE_HDR)
        && GET_ALG_FUN(HI_PQ_MODULE_HDR)->SetHdrOffset)
    {
...
static HI_S32 drv_pq_ProcSetHdrTM(HI_CHAR *pArg1, HI_CHAR *pArg2)
{
    ...
    if (GET_ALG(HI_PQ_MODULE_HDR)
        && GET_ALG_FUN(HI_PQ_MODULE_HDR)->SetHdrTMCurve)
    {
