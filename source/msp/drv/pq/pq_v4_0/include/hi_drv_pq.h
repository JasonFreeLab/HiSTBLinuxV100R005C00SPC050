...
typedef struct hiPQ_HDR_SOFT_PARA_S
{
    ...
    HI_U32 u32Contrast ;                  //调节对比度                               n = 1.25*256;
    HI_U32 u32HdrLwAvg ;                     //300  最主要的调节参数 ;  //TM_EXP  源均值亮?
...
//#define HIIOC_PQ_G_COLORTEMP            _IOWR(HI_ID_PQ, 2, HI_PQ_COLOR_TEMP_S)         /* 获取色温参数*/
...
#define HIIOC_PQ_G_BACKLIGHT            _IOWR(HI_ID_PQ, 24, HI_U32)                    /* 获取BackLight level*/

#define HIIOC_PQ_S_GAMMAIDX             _IOW(HI_ID_PQ, 25, HI_S32)                    /* 设置GAMMA index*/
#define HIIOC_PQ_G_GAMMANUM             _IOWR(HI_ID_PQ, 26, HI_S32)                    /* 获取GAMMA num*/
...
#define HIIOC_PQ_G_NR_AUTO              _IOWR(HI_ID_PQ, 34, HI_U32)                    /* 获取NR自动模式*/
...
#define HIIOC_PQ_G_3DSHARP              _IOWR(HI_ID_PQ, 41, HI_U32)                    /* 获取3D SHARP mode*/

//#define HIIOC_PQ_S_CSCMODE                    _IOW(HI_ID_PQ, 42, HI_PQ_CSC_S)                          /* 设置CSC mode*/
//#define HIIOC_PQ_G_CSCMODE                    _IOWR(HI_ID_PQ, 43, HI_PQ_CSC_S)                           /* 获取CSC mode*/
...
//#define HIIOC_PQ_G_GAMMA                      _IOWR(HI_ID_PQ, 47, HI_PQ_GAMMA_TABLE_S)             /*读GAMMA曲线*/
