...
typedef enum
{
    PMOC_HOLD_ETH = 0x0001,   /**<Keep eth working */    /**<CNcomment:���ڲ��µ� */
    PMOC_HOLD_WIFI = 0x0002,  /**<Keep WIFI working */   /**<CNcomment:WIFI���µ� */
    PMOC_HOLD_USB = 0x0004,   /**<Keep USB working */    /**<CNcomment:USB���µ� */
    PMOC_HOLD_TUNER = 0x0008, /**<Keep tuner working */  /**<CNcomment:Tuner���µ� */
    PMOC_HOLD_DEMUX = 0x0010, /**<Keep demux working */  /**<CNcomment:Demux���µ� */
    PMOC_HOLD_SDIO = 0x0020,  /**<Keep SDIO working */   /**<CNcomment:SD�����µ� */
    PMOC_HOLD_SCI = 0x0040,   /**<Keep SCI working */    /**<CNcomment:SCI���µ� */
    PMOC_HOLD_VENC = 0x0080,  /**<Keep VENC working */   /**<CNcomment:VENC���µ� */
    PMOC_HOLD_PNG = 0x0100,   /**<Keep PNG working */    /**<CNcomment:PNG���µ� */
    PMOC_HOLD_JPGE = 0x0200,  /**<Keep JPGE working */   /**<CNcomment:JPGE���µ� */
    PMOC_HOLD_JPEG = 0x0400,  /**<Keep JPEG working */   /**<CNcomment:JPEG���µ� */
    PMOC_HOLD_WDG = 0x0800,   /**<Keep WDG working */    /**<CNcomment:WDG���µ� */
    PMOC_HOLD_HDMI = 0x1000,  /**<Keep HDMI working */   /**<CNcomment:HDMI���µ� */
    PMOC_HOLD_VO = 0x2000,    /**<Keep VO working */     /**<CNcomment:VO���µ� */
    PMOC_HOLD_DISP = 0x4000,  /**<Keep DISP working */   /**<CNcomment:DISP���µ� */
    PMOC_HOLD_AO = 0x8000,    /**<Keep AO working */     /**<CNcomment:AO���µ� */
    PMOC_HOLD_AI = 0x10000,   /**<Keep AI working */     /**<CNcomment:AI���µ� */
    PMOC_HOLD_ADSP = 0x20000, /**<Keep ADSP working */   /**<CNcomment:ADSP���µ� */
    PMOC_HOLD_CIPHER = 0x40000, /**<Keep CIPHER working */   /**<CNcomment:CIPHER���µ� */
    PMOC_HOLD_VDEC = 0x80000, /**<Keep VDEC working */   /**<CNcomment:VDEC���µ� */
    PMOC_HOLD_VPSS = 0x100000, /**<Keep VPSS working */  /**<CNcomment:VPSS���µ� */
    PMOC_HOLD_OTP = 0x200000, /**<Keep OTP working */    /**<CNcomment:OTP���µ� */
    PMOC_HOLD_TDE = 0x400000, /**<Keep TDE working */    /**<CNcomment:TDE���µ� */
    PMOC_HOLD_I2C = 0x800000, /**<Keep I2C working */    /**<CNcomment:I2C���µ� */
    PMOC_HOLD_GPIO = 0x1000000,/**<Keep GPIO working */  /**<CNcomment:GPIO���µ� */
    PMOC_HOLD_PQ   = 0x2000000,/**<Keep PQ working */  /**<CNcomment:PQ���µ� */
