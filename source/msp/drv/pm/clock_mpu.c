...
CPU_VF_S cpu_freq_hpm_table_300[MAX_FREQ_NUM] =
{
    ...
    { 600000, HI_VDD_MPU_OPP2_HPM_300, HI_VDD_MPU_OPP2_VMIN_300, HI_VDD_MPU_OPP2_UV_300},
    { 800000, HI_VDD_MPU_OPP3_HPM_300, HI_VDD_MPU_OPP3_VMIN_300, HI_VDD_MPU_OPP3_UV_300},
    {1200000, HI_VDD_MPU_OPP5_HPM_300, HI_VDD_MPU_OPP5_VMIN_300, HI_VDD_MPU_OPP5_UV_300},
    {1600000, HI_VDD_MPU_OPP7_HPM_300, HI_VDD_MPU_OPP7_VMIN_300, HI_VDD_MPU_OPP7_UV_300},
};
#endif
    ...
    for (i = 0; i < MAX_FREQ_NUM; i++)
    {
        if (rate == cpu_freq_hpm_table[i].freq)
        {
            ...
            if ((HI_CHIP_TYPE_HI3798M == g_enChipType) && (HI_CHIP_VERSION_V300 == g_enChipID))
            {
                ...
                regval = ((((CPU_VMAX - cpu_freq_hpm_table_300[i].vmin) * PWM_CLASS) / PWM_STEP) + 1) << 16;
                regval |= (((CPU_VMAX - cpu_freq_hpm_table_300[i].vsetting) * PWM_CLASS) / PWM_STEP) + 1;
