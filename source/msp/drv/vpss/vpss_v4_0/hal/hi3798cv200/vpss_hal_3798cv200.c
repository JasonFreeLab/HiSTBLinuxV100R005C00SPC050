...
HI_S32 VPSS_HAL_GetNodeAddr(VPSS_IP_E enIP, HI_U32 u32NodeId, HI_U8
                            **pstRegAddr, HI_CHAR **ppNodeName)
{
                               ...
                               HI_U32 u32PortCnt)
{
    ...
    //4pixel align
    pstInCropRect->s32Width = pstInCropRect->s32Width & VPSS_WIDTH_ALIGN_4PIXELCLK;
