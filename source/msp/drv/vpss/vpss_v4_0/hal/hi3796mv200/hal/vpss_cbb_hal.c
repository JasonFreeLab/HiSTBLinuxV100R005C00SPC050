                              ...
                              VPSS_RWZB_INFO_S *pstRwzbInfo, HI_U32 u32YCMode, HI_BOOL bField)
{
    ...
    for (ii = 0; ii < 6; ii++)
    {
            ...
            && (u32_blk_ypos < pstRwzbInfo->u32Height))
        {
            ...
            {
                VPSS_DBG_INFO("\r\n%d- X Y W H %d %d %d %d\t",
                              ii, u32_blk_xpos, u32_blk_ypos, pstRwzbInfo->u32Width, pstRwzbInfo->u32Height);
                for (jj = 0; jj < 8; jj++)
                {
...
HI_S32 VPSS_HAL_Set_2DDei_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    {
        VPSS_FATAL("FMTC do not support interlace frame(dei)\n");
    }
    VPSS_AlgCfg_BaseFunc(stRegAddr, CBB_ALG_FMTC, (HI_VOID *)&stFMTCInfo, HI_NULL);
