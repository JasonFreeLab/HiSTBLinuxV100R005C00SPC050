...
HI_VOID* VencKernelRegisterMap(unsigned long PhyAddr, unsigned long size)
{
    return ioremap (PhyAddr, size);
}

HI_VOID VencKernelRegisterUnMap(HI_VOID* VirAddr)
{
    iounmap(VirAddr);
    return;
}
...
/************************************************************************/
VOID *OSAL_VmallocVirMem(SINT32 Size)
{
    return vmalloc(Size);
}
/************************************************************************/
