...
#define DMX_INT_NUM                     (82 + 32)/*A9һ����128���жϣ�A9�Լ�ռ��32��*/
...
/*******************************************
*DMX_RAMPORT_CNT = 5 for CHIP_TYPE_hi3798mv210
*DMX_RAMPORT_CNT = 3 for CHIP_TYPE_hi3798mv200 and CHIP_TYPE_hi3798mv200_a
*******************************************/
#define DMX_RAMPORT_CNT              5
#define DMX_TAGPORT_CNT              0
#define DMX_TSIOPORT_CNT             0
...
/* 98mv200 didn't use PID copy function and close it to improve the performance */
//#define DMX_DUP_PID_CHANNEL_SUPPORT
...
/* 96mv200 didn't use PID copy function and close it to improve the performance */
//#define DMX_DUP_PID_CHANNEL_SUPPORT
#else
