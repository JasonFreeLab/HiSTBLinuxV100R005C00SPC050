...
#define ADD_DMX_SET(ID, DmxSetInst) ({ \
    ...
    if(((enChipType == HI_CHIP_TYPE_HI3798M) || (enChipType == HI_CHIP_TYPE_HI3798M_A))&&(enChipVersion == HI_CHIP_VERSION_V200))\
...
{
    *SyncErrCnt      = DmxHalDvbPortGetSyncByteErrCount(PortId);
    return HI_SUCCESS;
}
...
HI_S32 DMX_OsiPortGetCCDiscErrPacketNum(const HI_U32 PortId, HI_U32 *pCCDiscErrCnt)
{
    HI_U32 i;
    DMX_ChanInfo_S *ChanInfo;
    Dmx_Set_S *DmxSet = HI_NULL;
    ...
    if (HI_UNF_DMX_REC_INDEX_TYPE_VIDEO == RecInfo->IndexType)
    {
        ...
        switch(RecInfo->VCodecType)
        {
            ...
            case HI_UNF_VCODEC_TYPE_HEVC:
                ...
                DmxHalSetScdRangeFilter(DmxSet, 9, 0x50, 0x40, 0x7E); /* [0x20 ~ 0x28] << 1 */
