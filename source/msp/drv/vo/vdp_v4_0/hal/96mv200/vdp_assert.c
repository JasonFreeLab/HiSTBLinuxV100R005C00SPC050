...
//             VDP_ASSERT(DHD0_VSYNC.bits.vfb + DHD0_VSYNC.bits.vbb > 13);
    ...
    VDP_ASSERT((VOAXICTRL.bits.m0_outstd_rid0 >= 1) && (VOAXICTRL.bits.m0_outstd_rid0 <= 15));
    VDP_ASSERT((VOAXICTRL.bits.m1_outstd_rid0 >= 1) && (VOAXICTRL.bits.m1_outstd_rid0 <= 15));
    VDP_ASSERT((VOAXICTRL.bits.m0_outstd_rid1 >= 1) && (VOAXICTRL.bits.m0_outstd_rid1 <= 15));
    VDP_ASSERT((VOAXICTRL.bits.m1_outstd_rid1 >= 1) && (VOAXICTRL.bits.m1_outstd_rid1 <= 15));

    VDP_ASSERT((VOAXICTRL.bits.m0_wr_ostd >= 1) && (VOAXICTRL.bits.m0_wr_ostd <= 15));
    VDP_ASSERT((VOAXICTRL.bits.m1_wr_ostd >= 1) && (VOAXICTRL.bits.m1_wr_ostd <= 15));
