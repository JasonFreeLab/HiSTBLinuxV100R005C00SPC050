...
#if 1
HI_S32 VDP_VID_TileDcmpLWrongStateRead(HI_U32 u32Data)
{
	U_V0_DCMP_ERR  V0_DCMP_ERR;
	if(u32Data != VDP_LAYER_VID0)
	{
	    VDP_PRINT("Error,VDP_VID_TileDcmpLWrongStateRead() Select Wrong Video Layer ID\n");
	    return HI_FALSE;
	}

	V0_DCMP_ERR.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_DCMP_ERR.u32) + u32Data * VID_OFFSET));

	return V0_DCMP_ERR.bits.dcmp_l_wrong;
}

HI_S32 VDP_VID_TileDcmpCWrongStateRead(HI_U32 u32Data)
{
	U_V0_DCMP_ERR  V0_DCMP_ERR;
	if(u32Data != VDP_LAYER_VID0)
	{
	    VDP_PRINT("Error,VDP_VID_TileDcmpCWrongStateRead() Select Wrong Video Layer ID\n");
	    return HI_FALSE;
	}

	V0_DCMP_ERR.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_DCMP_ERR.u32) + u32Data * VID_OFFSET));

	return V0_DCMP_ERR.bits.dcmp_c_wrong;
}

HI_S32 VDP_VID_TileDcmpLForgiverStateRead(HI_U32 u32Data)
{
	U_V0_DCMP_ERR  V0_DCMP_ERR;
	if(u32Data != VDP_LAYER_VID0)
	{
	    VDP_PRINT("Error,VDP_VID_TileDcmpLForgiverStateRead() Select Wrong Video Layer ID\n");
	    return HI_FALSE;
	}

	V0_DCMP_ERR.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_DCMP_ERR.u32) + u32Data * VID_OFFSET));

	return V0_DCMP_ERR.bits.l_forgive_err;
}


HI_S32 VDP_VID_TileDcmpCForgiverStateRead(HI_U32 u32Data)
{
	U_V0_DCMP_ERR  V0_DCMP_ERR;
	if(u32Data != VDP_LAYER_VID0)
	{
	    VDP_PRINT("Error,VDP_VID_TileDcmpCForgiverStateRead() Select Wrong Video Layer ID\n");
	    return HI_FALSE;
	}

	V0_DCMP_ERR.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_DCMP_ERR.u32) + u32Data * VID_OFFSET));

	return V0_DCMP_ERR.bits.c_forgive_err;
}

HI_S32 VDP_VID_TileDcmpLConsumeStateRead(HI_U32 u32Data)
{
	U_V0_DCMP_ERR  V0_DCMP_ERR;
	if(u32Data != VDP_LAYER_VID0)
	{
	    VDP_PRINT("Error,VDP_VID_TileDcmpLConsumeStateRead() Select Wrong Video Layer ID\n");
	    return HI_FALSE;
	}

	V0_DCMP_ERR.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_DCMP_ERR.u32) + u32Data * VID_OFFSET));

	return V0_DCMP_ERR.bits.l_consume_err;
}

HI_S32 VDP_VID_TileDcmpCConsumeStateRead(HI_U32 u32Data)
{
	U_V0_DCMP_ERR  V0_DCMP_ERR;
	if(u32Data != VDP_LAYER_VID0)
	{
	    VDP_PRINT("Error,VDP_VID_TileDcmpCConsumeStateRead() Select Wrong Video Layer ID\n");
	    return HI_FALSE;
	}

	V0_DCMP_ERR.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_DCMP_ERR.u32) + u32Data * VID_OFFSET));

	return V0_DCMP_ERR.bits.c_consume_err;
}

HI_S32 VDP_VID_TileDcmpLHeadStateRead(HI_U32 u32Data)
{
	U_V0_DCMP_ERR  V0_DCMP_ERR;
	if(u32Data != VDP_LAYER_VID0)
	{
	    VDP_PRINT("Error,VDP_VID_TileDcmpLHeadStateRead() Select Wrong Video Layer ID\n");
	    return HI_FALSE;
	}

	V0_DCMP_ERR.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_DCMP_ERR.u32) + u32Data * VID_OFFSET));

	return V0_DCMP_ERR.bits.l_head_err;
}

HI_S32 VDP_VID_TileDcmpCHeadStateRead(HI_U32 u32Data)
{
	U_V0_DCMP_ERR  V0_DCMP_ERR;
	if(u32Data != VDP_LAYER_VID0)
	{
	    VDP_PRINT("Error,VDP_VID_TileDcmpCHeadStateRead() Select Wrong Video Layer ID\n");
	    return HI_FALSE;
	}

	V0_DCMP_ERR.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_DCMP_ERR.u32) + u32Data * VID_OFFSET));

	return V0_DCMP_ERR.bits.c_head_err;
}
...
HI_VOID  VDP_VP_SetLayerBkg(HI_U32 u32Data, VDP_BKG_S stBkg)
{
    ...
    if(u32Data == VDP_LAYER_VP0)
    {
        ...
        //        VDP_RegWrite(&(pVdpReg->VP0_ALPHA.u32), VP0_ALPHA.u32);
    }
    else
    {
...
HI_VOID  VDP_VID_SetChromaCopyEn    (HI_U32 u32Data, HI_U32 u32ChCopyEn)
{
    U_V0_CTRL V0_CTRL;
    ...
    V0_CTRL.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_CTRL.u32) + u32Data * VID_OFFSET));
    V0_CTRL.bits.chroma_copy = u32ChCopyEn;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->V0_CTRL.u32) + u32Data * VID_OFFSET), V0_CTRL.u32);
