...
HI_S32 VDP_GFX_DcmpARWrongStateRead(HI_U32 u32Data)
{
	U_G0_DCMP_INTER   G0_DCMP_INTER;
	if(u32Data != VDP_LAYER_GFX0)
	{
	    VDP_PRINT("Error,VDP_GFX_DcmpARWrongStateRead() Select Wrong Gfx Layer ID\n");
	    return HI_FALSE;
	}

	G0_DCMP_INTER.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_DCMP_INTER.u32) + u32Data * GFX_OFFSET));

	return G0_DCMP_INTER.bits.dcmp_ar_errclr;
}

HI_S32 VDP_GFX_DcmpGBWrongStateRead(HI_U32 u32Data)
{
	U_G0_DCMP_INTER   G0_DCMP_INTER;
	if(u32Data != VDP_LAYER_GFX0)
	{
	...
	return G0_DCMP_INTER.bits.dcmp_gb_errclr;
}
...
//lower power drv start
HI_VOID VDP_GFX_SetLowPowerEn(HI_U32 u32Data, HI_U32 u32Enable)
{
    U_G0_CTRL2 G0_CTRL2;

    if(u32Data >= GFX_MAX)
    {
        VDP_PRINT("Error,VDP_GFX_SetLowPowerEn() Select Wrong Video Layer ID\n");
        return ;
    }

    G0_CTRL2.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_CTRL2.u32) + u32Data * GFX_OFFSET));
    G0_CTRL2.bits.lp_ctrl_en = u32Enable;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_CTRL2.u32) + u32Data * GFX_OFFSET), G0_CTRL2.u32);

    return ;
}

HI_VOID VDP_GP_SetLowPowerEn(HI_U32 u32Data, HI_U32 u32Enable)
{
    U_GP0_CTRL GP0_CTRL;
    if(u32Data >= GP_MAX)
    {
        VDP_PRINT("Error,VDP_GP_SetLowPowerEn Select Wrong Graph Layer ID\n");
        return ;
    }

    GP0_CTRL.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->GP0_CTRL.u32)+ u32Data * GP_OFFSET));
    GP0_CTRL.bits.lp_ctrl_en = u32Enable;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->GP0_CTRL.u32)+ u32Data * GP_OFFSET), GP0_CTRL.u32);
}

HI_VOID VDP_GFX_SetLowPowerPara(HI_U32 u32Data, VDP_LP_PARA_MODE_E u32Mode, VDP_LP_PARA_S stLpPara)
{
    U_G0_LP_INF00    G0_LP_INF00 = {{0}};
    U_G0_LP_INF01    G0_LP_INF01 = {{0}};
    U_G0_LP_INF02    G0_LP_INF02 = {{0}};
    U_G0_LP_INF03    G0_LP_INF03 = {{0}};
    U_G0_LP_INF04    G0_LP_INF04 = {{0}};
    U_G0_LP_INF05    G0_LP_INF05 = {{0}};
    U_G0_LP_INF06    G0_LP_INF06 = {{0}};
    U_G0_LP_INF07    G0_LP_INF07 = {{0}};
    U_G0_LP_INF08    G0_LP_INF08 = {{0}};
    U_G0_LP_INF09    G0_LP_INF09 = {{0}};
    U_G0_LP_INF10    G0_LP_INF10 = {{0}};
    U_G0_LP_INF11    G0_LP_INF11 = {{0}};
    U_G0_LP_INF12    G0_LP_INF12 = {{0}};
    U_G0_LP_INF13    G0_LP_INF13 = {{0}};
    U_G0_LP_INF14    G0_LP_INF14 = {{0}};
    U_G0_LP_INF15    G0_LP_INF15 = {{0}};
    U_G0_LP_INF16    G0_LP_INF16 = {{0}};

    VDP_LP_PARA_S stLpParaCfg;

  	memset(&stLpParaCfg, 0x0, sizeof(stLpParaCfg));

    if(u32Data >= GFX_MAX)
    {
        VDP_PRINT("Error,VDP_GFX_SetLowPowerPara() Select Wrong Video Layer ID\n");
        return ;
    }

    if(u32Mode == VDP_LP_PARA_MODE_ZERO)
    {
        stLpParaCfg.lp_para_00 = 0x0;
        stLpParaCfg.lp_para_01 = 0x0;
        stLpParaCfg.lp_para_02 = 0x0;
        stLpParaCfg.lp_para_03 = 0x0;
        stLpParaCfg.lp_para_04 = 0x0;
        stLpParaCfg.lp_para_05 = 0x0;
        stLpParaCfg.lp_para_06 = 0x0;
        stLpParaCfg.lp_para_07 = 0x0;
        stLpParaCfg.lp_para_08 = 0x0;
        stLpParaCfg.lp_para_09 = 0x0;
        stLpParaCfg.lp_para_10 = 0x0;
        stLpParaCfg.lp_para_11 = 0x0;
        stLpParaCfg.lp_para_12 = 0x0;
        stLpParaCfg.lp_para_13 = 0x0;
        stLpParaCfg.lp_para_14 = 0x0;
        stLpParaCfg.lp_para_15 = 0x0;
        stLpParaCfg.lp_para_16 = 0x0;
    }
    else if(u32Mode == VDP_LP_PARA_MODE_NZERO)
    {
        stLpParaCfg.lp_para_00 = 0xffffffff;
        stLpParaCfg.lp_para_01 = 0xffffffff;
        stLpParaCfg.lp_para_02 = 0xffffffff;
        stLpParaCfg.lp_para_03 = 0xffffffff;
        stLpParaCfg.lp_para_04 = 0xffffffff;
        stLpParaCfg.lp_para_05 = 0xffffffff;
        stLpParaCfg.lp_para_06 = 0xffffffff;
        stLpParaCfg.lp_para_07 = 0xffffffff;
        stLpParaCfg.lp_para_08 = 0xffffffff;
        stLpParaCfg.lp_para_09 = 0xffffffff;
        stLpParaCfg.lp_para_10 = 0xffffffff;
        stLpParaCfg.lp_para_11 = 0xffffffff;
        stLpParaCfg.lp_para_12 = 0xffffffff;
        stLpParaCfg.lp_para_13 = 0xffffffff;
        stLpParaCfg.lp_para_14 = 0xffffffff;
        stLpParaCfg.lp_para_15 = 0xffffffff;
        stLpParaCfg.lp_para_16 = 0xffffffff;

    }
    else if(u32Mode == VDP_LP_PARA_MODE_INTERVAL)
    {
        stLpParaCfg.lp_para_00 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_01 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_02 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_03 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_04 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_05 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_06 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_07 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_08 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_09 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_10 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_11 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_12 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_13 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_14 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_15 = 0xAAAAAAAA;
        stLpParaCfg.lp_para_16 = 0xAAAAAAAA;
    }
    else if(u32Mode == VDP_LP_PARA_MODE_NINTERVAL)
    {
        stLpParaCfg.lp_para_00 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_01 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_02 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_03 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_04 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_05 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_06 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_07 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_08 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_09 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_10 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_11 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_12 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_13 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_14 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_15 = 0xF0F0F0F0;
        stLpParaCfg.lp_para_16 = 0xF0F0F0F0;

    }

    else if(u32Mode == VDP_LP_PARA_MODE_VLD1)
    {
        stLpParaCfg.lp_para_00 = 0x0;
        stLpParaCfg.lp_para_01 = 0x0;
        stLpParaCfg.lp_para_02 = 0x0;
        stLpParaCfg.lp_para_03 = 0x0;
        stLpParaCfg.lp_para_04 = 0x1;
        stLpParaCfg.lp_para_05 = 0x0;
        stLpParaCfg.lp_para_06 = 0x0;
        stLpParaCfg.lp_para_07 = 0x0;
        stLpParaCfg.lp_para_08 = 0x0;
    ...
    else if(u32Mode == VDP_LP_PARA_MODE_NVLD1)
    {
        stLpParaCfg.lp_para_00 = 0xffffffff;
        stLpParaCfg.lp_para_01 = 0xffffffff;
        stLpParaCfg.lp_para_02 = 0xffffffff;
        stLpParaCfg.lp_para_03 = 0xfffeffff;
        stLpParaCfg.lp_para_04 = 0xffffffff;
        stLpParaCfg.lp_para_05 = 0xffffffff;
        stLpParaCfg.lp_para_06 = 0xffffffff;
        stLpParaCfg.lp_para_07 = 0xffffffff;
    ...
    else if(u32Mode == VDP_LP_PARA_MODE_NVLD2)
    {
        stLpParaCfg.lp_para_00 = 0xffffffff;
        stLpParaCfg.lp_para_01 = 0xffffffff;
        stLpParaCfg.lp_para_02 = 0xffffffff;
        ...
        stLpParaCfg.lp_para_05 = 0xffffffff;
        stLpParaCfg.lp_para_06 = 0xffffffff;
        stLpParaCfg.lp_para_07 = 0xfffeffff;
        stLpParaCfg.lp_para_08 = 0xffffffff;
        stLpParaCfg.lp_para_09 = 0xffffffff;
        stLpParaCfg.lp_para_10 = 0xffffffff;
        stLpParaCfg.lp_para_11 = 0xffffffff;
    ...
    else if(u32Mode == VDP_LP_PARA_MODE_CFG)
    {
        stLpParaCfg.lp_para_00 = stLpPara.lp_para_00;
        stLpParaCfg.lp_para_01 = stLpPara.lp_para_01;
        stLpParaCfg.lp_para_02 = stLpPara.lp_para_02;
        stLpParaCfg.lp_para_03 = stLpPara.lp_para_03;
        stLpParaCfg.lp_para_04 = stLpPara.lp_para_04;
        stLpParaCfg.lp_para_05 = stLpPara.lp_para_05;
        stLpParaCfg.lp_para_06 = stLpPara.lp_para_06;
        stLpParaCfg.lp_para_07 = stLpPara.lp_para_07;
        stLpParaCfg.lp_para_08 = stLpPara.lp_para_08;
        stLpParaCfg.lp_para_09 = stLpPara.lp_para_09;
        stLpParaCfg.lp_para_10 = stLpPara.lp_para_10;
        stLpParaCfg.lp_para_11 = stLpPara.lp_para_11;
        stLpParaCfg.lp_para_12 = stLpPara.lp_para_12;
        stLpParaCfg.lp_para_13 = stLpPara.lp_para_13;
        stLpParaCfg.lp_para_14 = stLpPara.lp_para_14;
        stLpParaCfg.lp_para_15 = stLpPara.lp_para_15;
        stLpParaCfg.lp_para_16 = stLpPara.lp_para_16;

    }
    else if(u32Mode == VDP_LP_PARA_MODE_RAND)
    {
    #if 0
            stLpParaCfg.lp_para_00 = rand()%4294967296;
            stLpParaCfg.lp_para_01 = rand()%4294967296;
            stLpParaCfg.lp_para_02 = rand()%4294967296;
            stLpParaCfg.lp_para_03 = rand()%4294967296;
            stLpParaCfg.lp_para_04 = rand()%4294967296;
            stLpParaCfg.lp_para_05 = rand()%4294967296;
            stLpParaCfg.lp_para_06 = rand()%4294967296;
            stLpParaCfg.lp_para_07 = rand()%4294967296;
            stLpParaCfg.lp_para_08 = rand()%4294967296;
            stLpParaCfg.lp_para_09 = rand()%4294967296;
            stLpParaCfg.lp_para_10 = rand()%4294967296;
            stLpParaCfg.lp_para_11 = rand()%4294967296;
            stLpParaCfg.lp_para_12 = rand()%4294967296;
            stLpParaCfg.lp_para_13 = rand()%4294967296;
            stLpParaCfg.lp_para_14 = rand()%4294967296;
            stLpParaCfg.lp_para_15 = rand()%4294967296;
            stLpParaCfg.lp_para_16 = rand()%4294967296;
 #endif

    }

    G0_LP_INF00.u32  = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF00.u32 ) + u32Data * GFX_OFFSET));
    G0_LP_INF01.u32  = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF01.u32 ) + u32Data * GFX_OFFSET));
    G0_LP_INF02.u32  = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF02.u32 ) + u32Data * GFX_OFFSET));
    G0_LP_INF03.u32  = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF03.u32 ) + u32Data * GFX_OFFSET));
    G0_LP_INF04.u32  = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF04.u32 ) + u32Data * GFX_OFFSET));
    G0_LP_INF05.u32  = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF05.u32 ) + u32Data * GFX_OFFSET));
    G0_LP_INF06.u32  = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF06.u32 ) + u32Data * GFX_OFFSET));
    G0_LP_INF07.u32  = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF07.u32 ) + u32Data * GFX_OFFSET));
    G0_LP_INF08.u32  = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF08.u32 ) + u32Data * GFX_OFFSET));
    G0_LP_INF09.u32  = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF09.u32 ) + u32Data * GFX_OFFSET));
    G0_LP_INF10.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF10.u32) + u32Data * GFX_OFFSET));
    G0_LP_INF11.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF11.u32) + u32Data * GFX_OFFSET));
    G0_LP_INF12.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF12.u32) + u32Data * GFX_OFFSET));
    G0_LP_INF13.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF13.u32) + u32Data * GFX_OFFSET));
    G0_LP_INF14.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF14.u32) + u32Data * GFX_OFFSET));
    G0_LP_INF15.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF15.u32) + u32Data * GFX_OFFSET));
    G0_LP_INF16.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->G0_LP_INF16.u32) + u32Data * GFX_OFFSET));
    G0_LP_INF00.bits.lp_info00 = stLpParaCfg.lp_para_00;
    G0_LP_INF01.bits.lp_info01 = stLpParaCfg.lp_para_01;
    G0_LP_INF02.bits.lp_info02 = stLpParaCfg.lp_para_02;
    G0_LP_INF03.bits.lp_info03 = stLpParaCfg.lp_para_03;
    G0_LP_INF04.bits.lp_info04 = stLpParaCfg.lp_para_04;
    G0_LP_INF05.bits.lp_info05 = stLpParaCfg.lp_para_05;
    G0_LP_INF06.bits.lp_info06 = stLpParaCfg.lp_para_06;
    G0_LP_INF07.bits.lp_info07 = stLpParaCfg.lp_para_07;
    G0_LP_INF08.bits.lp_info08 = stLpParaCfg.lp_para_08;
    G0_LP_INF09.bits.lp_info09 = stLpParaCfg.lp_para_09;
    G0_LP_INF10.bits.lp_info10 = stLpParaCfg.lp_para_10;
    G0_LP_INF11.bits.lp_info11 = stLpParaCfg.lp_para_11;
    G0_LP_INF12.bits.lp_info12 = stLpParaCfg.lp_para_12;
    G0_LP_INF13.bits.lp_info13 = stLpParaCfg.lp_para_13;
    G0_LP_INF14.bits.lp_info14 = stLpParaCfg.lp_para_14;
    G0_LP_INF15.bits.lp_info15 = stLpParaCfg.lp_para_15;
    G0_LP_INF16.bits.lp_info16 = stLpParaCfg.lp_para_16;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF00.u32  ) + u32Data * GFX_OFFSET ) , G0_LP_INF00.u32  ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF01.u32  ) + u32Data * GFX_OFFSET ) , G0_LP_INF01.u32  ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF02.u32  ) + u32Data * GFX_OFFSET ) , G0_LP_INF02.u32  ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF03.u32  ) + u32Data * GFX_OFFSET ) , G0_LP_INF03.u32  ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF04.u32  ) + u32Data * GFX_OFFSET ) , G0_LP_INF04.u32  ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF05.u32  ) + u32Data * GFX_OFFSET ) , G0_LP_INF05.u32  ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF06.u32  ) + u32Data * GFX_OFFSET ) , G0_LP_INF06.u32  ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF07.u32  ) + u32Data * GFX_OFFSET ) , G0_LP_INF07.u32  ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF08.u32  ) + u32Data * GFX_OFFSET ) , G0_LP_INF08.u32  ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF09.u32  ) + u32Data * GFX_OFFSET ) , G0_LP_INF09.u32  ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF10.u32 ) + u32Data * GFX_OFFSET ) , G0_LP_INF10.u32 ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF11.u32 ) + u32Data * GFX_OFFSET ) , G0_LP_INF11.u32 ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF12.u32 ) + u32Data * GFX_OFFSET ) , G0_LP_INF12.u32 ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF13.u32 ) + u32Data * GFX_OFFSET ) , G0_LP_INF13.u32 ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF14.u32 ) + u32Data * GFX_OFFSET ) , G0_LP_INF14.u32 ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF15.u32 ) + u32Data * GFX_OFFSET ) , G0_LP_INF15.u32 ) ;
    VDP_RegWrite(((HI_ULONG)&(pVdpReg->G0_LP_INF16.u32 ) + u32Data * GFX_OFFSET ) , G0_LP_INF16.u32 ) ;
