...
HI_VOID VDP_GP_SetGdmCscMode(HI_U32 enLayer, VDP_CSC_MODE_E enCscMode)
{
        ...
        if(enCscMode == VDP_CSC_RGB2YUV_709)
        {
           ...
           gdm_22_rgb2yuv               =  -659 ;
            ...
            gdm_rgb2yuv_0_in_dc           = 0       ;
            gdm_rgb2yuv_1_in_dc           = 0       ;
            gdm_rgb2yuv_2_in_dc           = 0       ;

            gdm_rgb2yuv_0_out_dc       = 64      ;
            gdm_rgb2yuv_1_out_dc       = 512     ;
            gdm_rgb2yuv_2_out_dc       = 512     ;
        }
        else
        {
