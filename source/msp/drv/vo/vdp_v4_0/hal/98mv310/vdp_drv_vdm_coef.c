...
#else
    if (HI_NULL == (HI_S32*)HiHdrCfg->stGmm.pu32LUT)
    {
        VDP_PRINT("pstHiHdrCfg stGmm is NULL!\n");
...
#else
        if (HI_NULL == (HI_S32*)HiHdrCfg->stDeGmm.pu32LUT)
        {
...
#else
            if (HI_NULL == (HI_S32*)HiHdrCfg->stTMAP.pu32LUTTM)
            {
