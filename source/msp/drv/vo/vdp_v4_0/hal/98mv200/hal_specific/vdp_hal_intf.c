        ...
        VDP_LAYER_VID_INFO_S *pstVidInfo)
{
    ...
    if (!pLayerCfgBasePara->bMuteEn && pLayerCfgBasePara->bRegionEn)
    {
            ...
            || (pLayerCfgBasePara->u32LayerNO == VDP_LAYER_VID1))
        {
            ...
            pstZmeIn.stLayerStrategy.bZmeFrmFmtOut   = (VDP_DISP_GetDispMode(0) == 1) ? 1 : 0;
            pstZmeIn.stLayerStrategy.bZmeBFIn    = !bBtm;
            pstZmeIn.stLayerStrategy.bZmeBFOut   = !bBtm;
            ...
            {
                pstVidInfo->stZme2InRect.u32Wth  =  pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInWidth;
                pstVidInfo->stZme2InRect.u32Hgt  =  pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInHeight;
            }
            else
            {
                //VDP_PRINT("---line:%d:%d!\n", __LINE__, pstZmeOut.stStrategyLayerId.u32ZmeNum);
                pstVidInfo->stZme2InRect.u32Wth  =  pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].u32FrmOutWidth;
                pstVidInfo->stZme2InRect.u32Hgt  =  pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].u32FrmOutHeight;
            }
