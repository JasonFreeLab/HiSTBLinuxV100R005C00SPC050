...
void VBI_TtxDataCorrectAndParse(HI_U32 TtxDataLen, HI_U32   TmpIndex)
{
    HI_U32 i;
    HI_BOOL     DataCorrectFlag = HI_TRUE;
...
void  VBI_StartASendingOfTtxData(void)
{
...
HI_BOOL  VBI_CopyDataFromUser( HI_BOOL*  pSendFlag, HI_DRV_DISP_TTX_DATA_S* pstTtxData)
{
    HI_S32      Ret;
...
HI_S32 DRV_VBI_SendTtxData(HI_DRV_DISP_TTX_DATA_S* pstTtxData)
{
    ...
    if (HI_FAILURE == VBI_CopyDataFromUser(&SendFlag, pstTtxData))
    {
        return  HI_FAILURE;
    }
