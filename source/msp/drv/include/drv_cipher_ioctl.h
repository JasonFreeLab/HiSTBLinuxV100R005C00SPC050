...
#define    CMD_CIPHER_CENC_DECRYPT           _IOWR(HI_ID_CIPHER, 0x19, CIPHER_CENC_DECRYPT_S)
...
#define    CMD_CIPHER_COMPAT_CENC_DECRYPT    _IOWR(HI_ID_CIPHER, 0x19, CIPHER_COMPAT_CENC_DECRYPT_S)
#endif
