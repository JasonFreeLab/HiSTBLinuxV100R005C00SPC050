...
HI_S32 HAL_HDMI_CecMsgSend(struct hiHDMI_HAL_S *pstHdmiHal, HDMI_CEC_CMD_S* pstMsg)
{
    ...
    if (CEC_OPCODE_USER_CONTROL_PRESSED == stCecMsg.u8Opcode)
    {
        stCecMsg.stOperand.stRawData.u8Data[0] = (HI_U8)pstMsg->stOperand.enUIOpcode;
        stCecMsg.stOperand.stRawData.u8Length  = 1;
    }
    else
    {
