...
HI_S32 HI_DRV_HDMI_PreFormat(HI_UNF_HDMI_ID_E enHdmi)
{
    ...
    HDMI_INFO("HI_DRV_HDMI_PreFormat bUserStart=%d\n",bSetFormatStart);
#ifndef HDMI_MASK_START
...
HI_S32 HI_DRV_HDMI_SetFormat(HI_UNF_HDMI_ID_E enHdmi, HDMI_VIDEO_ATTR_S *pstVideoAttr)
{
    ...
    HDMI_INFO("\nenVideoFmt=%d,u32ClkFs=%d,u32PixelRepeat=%d,bVSyncPol=%d,bHSyncPol=%d,bDEPol=%d,enStereoMode=%d,\n"
                "enInBitDepth=%d,u32ColorSpace=%d,enBt2020Lum=%d,u32DispRatioWidth=%d,u32DispRatioHeight=%d\n",
