...
/* BEGIN: Modified for PN: When SLIC initialization, sound is abnormal by sdk, 2011/1/30 */
extern  void le89116_reg_read(unsigned char addr, unsigned char *val, unsigned char len);
/* END:   Modified for PN: When SLIC initialization, sound is abnormal by sdk, 2011/1/30 */
