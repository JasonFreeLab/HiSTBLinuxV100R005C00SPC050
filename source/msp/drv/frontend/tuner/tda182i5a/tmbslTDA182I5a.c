...
)
{
    ...
    if(err == TM_OK)
    {
        if ((pObj->TunerModeInUse & TDA182I5_Mode_LTO_Used)   == TDA182I5_Mode_LTO_Used)
        {
            err = iTDA182I5a_Write(pObj, &gTDA182I5a_Reg_LT_byte_1__LT_offset, (UInt8)TDA182I5a_LT_offset_1_step_offset_Rfin_to_LT_gain_p3dB, Bus_NoRead);
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "iTDA182I5a_Write(0x%08X) failed.", tUnit));
        }
    }
