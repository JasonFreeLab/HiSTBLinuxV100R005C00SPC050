...
#define DMD_INTERRUPT_MAILBOX_REG         0xA80A // interrupt status mailbox register 


#define DMD_INT_MASK_MAILBOX_REG         0xA862 // Host interrupt Mask mailbox register 

#define HOST_INT_NONE    0x0000
#define HOST_INT_ACDATA    0x0001
#define HOST_INT_EWS       0x0002
#define HOST_INT_TUNEDONE  0x0004
#define HOST_INT_GPI       0x0008
#define HOST_INT_FRMSYNC_CHANGED       0x0010
#define HOST_INT_REBOOT    0x8000
#define HOST_INT_ALL  (HOST_INT_ACDATA|HOST_INT_EWS|HOST_INT_TUNEDONE|HOST_INT_GPI|HOST_INT_FRMSYNC_CHANGED|HOST_INT_REBOOT)

#define INTR_MODE_BIT_SHIFT 5
#define HOST_INTR_MODE    0x0060 

typedef enum
{
  MXL68x_INTR_LEVEL_LOW = 0,
  MXL68x_INTR_LEVEL_HIGH,
  MXL68x_INTR_FALLING_EDGE,
  MXL68x_INTR_RISING_EDGE,
  MXL68x_INTR_MODE_MAX
} MXL68X_INTR_MODE_E;
