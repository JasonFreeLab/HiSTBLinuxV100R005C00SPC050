...
//unsigned char InitMax254();
//UINT8 Mxl254LockDemod(MXL_HRCLS_CHAN_ID_E chanId, MXL_HRCLS_DMD_ID_E demodId, UINT32 freqkHz, UINT8 bwMHz, MXL_HRCLS_QAM_TYPE_E qamType, UINT16 symbolRatekSps);
