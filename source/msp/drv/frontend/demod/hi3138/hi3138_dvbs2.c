...
* main\1    2016-03-16                                      NULL             Create this file.
***********************************************************************************/
...
HI_S32 hi3138_set_scramble(HI_U32 u32TunerPort, HI_U32 u32N )
{
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    s32Ret = hi3136_set_scramble(u32TunerPort, u32N);
    if(HI_SUCCESS != s32Ret)
    {
        HI_ERR_TUNER("-->IN--hi3136_set_scramble failed.\n");
        return s32Ret;
    }
