...
static HI_U16 _AribCC_MapUnicode_KANJI(HI_U8 u8Text, ARIBCC_PRTDIRECT_E stPrtDirection, HI_U8 *IsNonspace)
{
...
static HI_U16 _AribCC_MapUnicode_LATIN(HI_U8 u8Text)
{
    HI_U16 ret_unicode = 0;
...
static HI_U16 _AribCC_MapUnicode_SPECIAL(HI_U8 u8Text)
{
    HI_U16 ret_unicode = 0;
...
static HI_U16 _AribCC_MapUnicode_OtherChar(HI_U8 u8Text, HI_U8 u8CharSet)
{
    HI_U16 ret_unicode = 0;
    ...
    *IsNonspace = 0;
    switch(u8CharSet)
    {
        ...
        case ARIBCC_CHARSET_KANJI:
            ret_unicode = _AribCC_MapUnicode_KANJI(u8Text, stPrtDirection, IsNonspace);
            break;
        ...
        case ARIBCC_CHARSET_LATIN:
             ...
             ret_unicode = _AribCC_MapUnicode_LATIN(u8Text);
             break;
        case ARIBCC_CHARSET_SPECIAL:
            ...
            */
            ret_unicode = _AribCC_MapUnicode_SPECIAL(u8Text);
            break;

        default:
            ret_unicode = _AribCC_MapUnicode_OtherChar(u8Text, u8CharSet);
            break;
    }
...
/*source monitor*/
static HI_VOID _AribCC_DrawCaptionToWindow_ChgLine(HI_S32 CCType, ARIBCC_TEXTATTR_S *pstText, HI_S32 char_width, HI_S32 char_height)
{
    if( pstText->stFormat.stPrtDirect == CCARIB_PRINT_VERTICAL )
    {
...
static HI_VOID _AribCC_DrawCaptionToWindow_Nonespace(ARIBCC_TEXTATTR_S *pstText, HI_S32 char_width, HI_S32 char_height, HI_S32 *ps32X, HI_S32 *ps32Y)
{
...
static HI_S32 _AribCC_DrawCaptionToWindow_Run(HI_S32 CCType, HI_U16 *pu16Buf, HI_U16 u16BufLen, ARIBCC_TEXTATTR_S *pstText, HI_U8 is_nonspace_char,
                                                                                                                  HI_S32 char_width, HI_S32 char_height, HI_U8 char_interval, HI_S32 net_width)
{
    ...
    while( u16BufLen > 0 )
    {
        ...
        {
            /*carriage return*/
            (HI_VOID)_AribCC_DrawCaptionToWindow_ChgLine(CCType, pstText, char_width, char_height);
            continue;
        }
        ...
        if( is_nonspace_char )
        {
            _AribCC_DrawCaptionToWindow_Nonespace(pstText, char_width, char_height, &x, &y);
            is_nonspace_char = 0;
        }
...
static HI_S32 _AribCC_DrawCaptionToWindow(HI_S32 CCType,HI_U16 *pu16Buf, HI_U16 u16BufLen,HI_U8 u8HasNonspace)
{
    ...
    s32Ret = _AribCC_DrawCaptionToWindow_Run(CCType, pu16Buf, u16BufLen, pstText, is_nonspace_char,
                                                                        char_width, char_height, char_interval, net_width);
