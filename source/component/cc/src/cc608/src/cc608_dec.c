...
static HI_S32 CC608_DEC_Command_ChkPara(HI_U8 moduleID, CC608_OBJECT_S *pstObject, HI_U8 b1, HI_U8 b2)
{
    if (HI_NULL == pstObject)
    {
        DEC_TRACE("pstObject is null\n");
...
static HI_VOID _CC608_DEC_Decode_CtrlCode_BacP17 (HI_U8 module_id, HI_BOOL bCaptionMode, CC608_OBJECT_S *pstObject,
                                                                                                                    HI_U16 b1, HI_U16 b2, HI_U16 *pu16PreData, HI_U16 *pu16Buf)
{
    if( (b2>=0x21) && (b2<=0x23) )//
    {
    ...
    else if((b2>=0x2d) && (b2<=0x2f) &&!pstObject->bOnlyUseSolidBlackBGIn608)//BAC p17.table 3
    {
        if(pstObject->u8IsCaptureText && (CC608_DATA_CheckRowColumnValidation(module_id) == 0))
        {
            ...
            if( (*pu16PreData == 0x20) || !pstObject->bIgnoreBACWithoutSpace)
            {
                //(HI_VOID)CC608_DATA_Substitute(module_id);
                pu16Buf[0] = (b1<<8)|b2;
                CC608_DATA_Caption(module_id,pu16Buf,1);
            }
        }
    }
...
static HI_VOID _CC608_DEC_Decode_CtrlCode_Run(HI_U8 module_id, HI_BOOL bCaptionMode, HI_S32 s32FieldNum,
                                                                                              HI_U16 b1, HI_U16 b2, HI_U16 *pu16PreData, HI_U16 *pu16Buf)
{
    CC608_OBJECT_S *pstObject = CC608_OBJ_Get(module_id);
    if (HI_NULL == pstObject)
    {
        DEC_TRACE("%s %d, pstObject is null\n", __FUNCTION__, __LINE__);
        return;
    }
        ...
        if(pstObject->u8IsCaptureText && (CC608_DATA_CheckRowColumnValidation(module_id) == 0))
        {
            switch (b2&0x70)
            {
                ...
                case 0x30:  // for special character(table 49,P95)
                    ...
                    (HI_VOID)CC608_DEC_ExtCharSet(module_id,*pu16PreData, b1,b2);
                    break;
                default:
                    break;
            }
    ...
    case 0x05:  //field 2 control code p32.8.4
            ...
            break;
    case 0x07:  //(17 ..)or(1f ..)
            (HI_VOID)_CC608_DEC_Decode_CtrlCode_BacP17 (module_id, bCaptionMode, pstObject, b1, b2, pu16PreData, pu16Buf);
            break;
    default:
        break;
    }
...
static HI_S32 _CC608_DEC_Decode_CtrlCode(HI_U8 module_id, HI_BOOL bCaptionMode, HI_S32 s32Channel, HI_S32 s32FieldNum,
                                                                                              HI_U16 b1, HI_U16 b2, HI_U16 *pu16PreData, HI_U16 *pu16Buf)
{
    CC608_OBJECT_S *pstObject = CC608_OBJ_Get(module_id);
    if (HI_NULL == pstObject)
    ...
    {
        (HI_VOID)_CC608_DEC_Decode_CtrlCode_Run(module_id, bCaptionMode, s32FieldNum, b1, b2, pu16PreData, pu16Buf);
    }
...
static HI_S32 _CC608_DEC_Decode(HI_U8 module_id,HI_U16 u16Data, HI_BOOL bCaptionMode, HI_S32 s32Channel,HI_S32 s32FieldNum)
{
    ...
    {
        HI_S32 s32Ret = HI_SUCCESS;
        s32Ret = _CC608_DEC_Decode_CtrlCode(module_id, bCaptionMode, s32Channel, s32FieldNum, b1, b2, &u16PreData, &buf[0]);
        if (s32Ret != HI_SUCCESS)
        {
            return HI_FAILURE;
        }
