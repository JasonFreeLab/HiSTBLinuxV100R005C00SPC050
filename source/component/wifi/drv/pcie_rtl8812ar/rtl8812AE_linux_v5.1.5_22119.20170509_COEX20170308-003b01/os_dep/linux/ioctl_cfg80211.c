...
addkey_end:
	...
	if (ret < 0)
		rtw_drv_log_evt_report(padapter, WIFI_EXCEPTION_DRV_CMD_ERR, WIFI_NL80211_CMD_NEW_KEY_ERR);
#endif
	return ret;
...
#ifdef RTW_HUAWEI_CUSTOMIZATION
	if (ret < 0)
		rtw_drv_log_evt_report(padapter, WIFI_EXCEPTION_DRV_CMD_ERR, WIFI_NL80211_CMD_GET_STA_ERR);
#endif
}
...
#ifdef RTW_HUAWEI_CUSTOMIZATION
	if (ret < 0)
		rtw_drv_log_evt_report(padapter, WIFI_EXCEPTION_DRV_CMD_ERR, WIFI_NL80211_CMD_SET_INTF_ERR);
#endif
	return ret;
}
...
#ifdef RTW_HUAWEI_CUSTOMIZATION
		rtw_drv_log_evt_report(padapter, WIFI_EXCEPTION_DRV_CMD_ERR, WIFI_NL80211_CMD_TRIGGER_SCAN_ERR);
#endif
		ret = -EPERM;
		goto exit;
	}
...
#ifdef RTW_HUAWEI_CUSTOMIZATION
	if (ret < 0)
		rtw_drv_log_evt_report(padapter, WIFI_EXCEPTION_DRV_CMD_ERR, WIFI_NL80211_CMD_CONNECT_ERR);
#endif
				  ...
				  struct cfg80211_pmksa *pmksa)
{
	...
	{
#ifdef RTW_HUAWEI_CUSTOMIZATION
		rtw_drv_log_evt_report(padapter, WIFI_EXCEPTION_DRV_CMD_ERR, WIFI_NL80211_CMD_SET_PMKSA_ERR);
#endif
		return -EINVAL;
	}
