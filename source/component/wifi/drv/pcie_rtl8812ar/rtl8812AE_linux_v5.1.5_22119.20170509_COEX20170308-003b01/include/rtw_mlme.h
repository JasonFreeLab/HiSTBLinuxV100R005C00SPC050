...
#define RTW_MLME_DRV_LOG_EN			1
#define RTW_MLME_MAX_LOG_ENTRIES		16
#define WIFI_EXCEPTION_ASSOC			1
#define WIFI_EXCEPTION_AUTH			2
#define WIFI_EXCEPTION_USB_BUS_ERR	3
#define WIFI_EXCEPTION_FW_DL_ERR		4
#define WIFI_EXCEPTION_DRV_CMD_ERR	5
#define WIFI_EXCEPTION_PCI_BUS_ERR	6

#define WIFI_EXCE_FW_DL_SZ_EXCEED_ERR		1
#define WIFI_EXCE_FW_DL_CHKSUM_ERR			2
#define WIFI_EXCE_FW_DL_POLLING_ERR			3

#define WIFI_NL80211_CMD_NEW_KEY_ERR			1
#define WIFI_NL80211_CMD_GET_STA_ERR			2
#define WIFI_NL80211_CMD_SET_INTF_ERR			3
#define WIFI_NL80211_CMD_TRIGGER_SCAN_ERR	4
#define WIFI_NL80211_CMD_CONNECT_ERR			5
#define WIFI_NL80211_CMD_SET_PMKSA_ERR		6

#define WIFI_EXCE_PCI_TXDMA_ERR 1
#define WIFI_EXCE_PCI_RXDMA_ERR 2



struct mlme_log_evt_entry {
	u32 time_stamp;
	u8	evt_id;
	u8	bssid[ETH_ALEN];
	NDIS_802_11_SSID ssid;
...
struct mlme_log_evt_tab {
	struct mlme_log_evt_entry evt_entries[RTW_MLME_MAX_LOG_ENTRIES];
	u32 evt_num;
	u8 log_evt_en;
};
...
#endif
#ifdef RTW_HUAWEI_CUSTOMIZATION
	struct mlme_log_evt_tab	evt_tab;
#endif	/*RTW_HUAWEI_CUSTOMIZATION*/
};
...
#ifdef RTW_HUAWEI_CUSTOMIZATION
void rtw_drv_log_redirect_evt_callback(_adapter *padapter, u8 *pbuf);
#endif
