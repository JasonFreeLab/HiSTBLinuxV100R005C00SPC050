...
void rtl8812_sreset_xmit_status_check(_adapter *padapter)
{
	...
	if (txdma_status != 0x00) {
		...
		rtw_hal_sreset_reset(padapter);
            ...
            rtw_drv_log_evt_report(padapter, WIFI_EXCEPTION_PCI_BUS_ERR, WIFI_EXCE_PCI_TXDMA_ERR);
        #endif
	}
...
void rtl8812_sreset_linked_status_check(_adapter *padapter)
{
	...
	if (rx_dma_status != 0x00) {
        ...
        #ifdef RTW_HUAWEI_CUSTOMIZATION
            rtw_drv_log_evt_report(padapter, WIFI_EXCEPTION_PCI_BUS_ERR, WIFI_EXCE_PCI_RXDMA_ERR);
        #endif
    }
#if 0
