...
static unsigned BLSH_CRC32 (unsigned crc, const unsigned char* buf, unsigned len)
{
    crc = crc ^ 0xffffffffL;
...
HI_S32 BLSH_BlockDataVerify(HI_U8* pu8Data, HI_U32 u32Size, HI_U8* pu8ValueBuffer, HI_U32 u32BufferSize)
{
    ...
    LOADER_CHECK_PARAM(4 > u32BufferSize);

    u32CrcValue = (HI_U32)((pu8ValueBuffer)[0] << 24)
                | (HI_U32)((pu8ValueBuffer)[1] << 16)
                | (HI_U32)((pu8ValueBuffer)[2] << 8)
                | (HI_U32)((pu8ValueBuffer)[3]);

    u32CalValue = BLSH_CRC32(0, pu8Data, u32Size);
...
HI_S32 BLSH_BlockDataSignature(HI_U8* pu8Data, HI_U32 u32Size, HI_U8* pu8ValueBuffer, HI_U32 u32BufferSize)
{
    ...
    u32CrcValue = BLSH_CRC32(0, pu8Data, u32Size);

    pu8ValueBuffer[0] = ((u32CrcValue >> 24) & 0xFF);
    pu8ValueBuffer[1] = ((u32CrcValue >> 16) & 0xFF);
    pu8ValueBuffer[2] = ((u32CrcValue >> 8) & 0xFF);
    pu8ValueBuffer[3] = ((u32CrcValue) & 0xFF);
