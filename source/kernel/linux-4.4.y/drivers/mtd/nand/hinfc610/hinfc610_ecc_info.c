					...
					int *max_bitsflags)
{
	...
	hinfc_host->ecc.bbm_bitsflap = __bitsflap[31];
}
/*****************************************************************************/
				       ...
				       int *max_bitsflags)
{
	...
	hinfc_host->ecc.bbm_bitsflap = __bitsflap[15];
}
/*****************************************************************************/
				      ...
				      int *max_bitsflags)
{
	...
	hinfc_host->ecc.bbm_bitsflap = __bitsflap[7];
}
/*****************************************************************************/
				      ...
				      int *max_bitsflags)
{
	...
	hinfc_host->ecc.bbm_bitsflap = __bitsflap[3];
}
/*****************************************************************************/
				      ...
				      int *max_bitsflags)
{
	...
	hinfc_host->ecc.bbm_bitsflap = __bitsflap[1];
}
/*****************************************************************************/
