...
#define REG_CHECK_AREA_NUM                              0x0FB0
#define REG_START_ADDR(i)                               (0x0FB4 + (i) * 8)
#define REG_SIZE(i)                                     (0x0FB8 + (i) * 8)
#define REG_SC_CEP                                      0x0FF4
#define REG_SC_WAKEUP_FLAG                              0x0FF8
