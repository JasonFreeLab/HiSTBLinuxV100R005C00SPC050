...
static int hi3798mv310_boot_secondary(unsigned int cpu,
					struct task_struct *idle)
{
	unsigned long timeout;

	set_scu_boot_addr(0xFFFF0000,
		(unsigned int)virt_to_phys(hi3798mv310_secondary_startup));
...
static void hi3798mv310_secondary_init(unsigned int cpu)
{
	/*
...
static void hi3798mv310_smp_init_cpus(void)
{
...
struct smp_operations hi3798mv310_smp_ops __initdata = {
	.smp_init_cpus = hi3798mv310_smp_init_cpus,
	.smp_secondary_init = hi3798mv310_secondary_init,
	.smp_boot_secondary = hi3798mv310_boot_secondary,
#ifdef CONFIG_HOTPLUG_CPU
	.cpu_die = hi3798mv310_cpu_die,
#endif
};
