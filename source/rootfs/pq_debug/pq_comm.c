...
HI_S32 PQ_DRV_SetHdrTmXpos(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    CHECK_PTR_REINT(pu8Buffer);
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_S_HDR_TM_XPOS, pu8Buffer);
    return s32Ret;
}

HI_S32 PQ_DRV_GetHdrTmXpos(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    CHECK_PTR_REINT(pu8Buffer);
    HI_PQ_HDR_TM_XPOS_S stTmXpos;
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_G_HDR_TM_XPOS, &stTmXpos);
    CHECK_RETURN(s32Ret);
    memcpy(pu8Buffer, &stTmXpos, sizeof(HI_PQ_HDR_TM_XPOS_S));
    return s32Ret;
}

HI_S32 PQ_DRV_SetHdrTmMap(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    CHECK_PTR_REINT(pu8Buffer);
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_S_HDR_TONE_MAP, pu8Buffer);
    return s32Ret;
}

HI_S32 PQ_DRV_GetHdrTmYmap(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    CHECK_PTR_REINT(pu8Buffer);
    HI_PQ_HDR_TM_YMAP_S stTmYmap;
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_G_HDR_TM_YMAP, &stTmYmap);
    CHECK_RETURN(s32Ret);
    memcpy(pu8Buffer, &stTmYmap, sizeof(HI_PQ_HDR_TM_YMAP_S));
    return s32Ret;
}

HI_S32 PQ_DRV_SetHdrTmYmap(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    CHECK_PTR_REINT(pu8Buffer);
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_S_HDR_TM_YMAP, pu8Buffer);
    return s32Ret;
}

HI_S32 PQ_DRV_GetHdrTmMap(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    CHECK_PTR_REINT(pu8Buffer);
    HI_PQ_HDR_TONE_MAP_S stToneMap;
    memset(&stToneMap, 0 , sizeof(stToneMap));
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_G_HDR_TONE_MAP, &stToneMap);
    CHECK_RETURN(s32Ret);
    memcpy(pu8Buffer, &stToneMap, sizeof(HI_PQ_HDR_TONE_MAP_S));
    return s32Ret;
}

HI_S32 PQ_DRV_SetHdrSatMap(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    CHECK_PTR_REINT(pu8Buffer);
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_S_HDR_SAT_MAP, pu8Buffer);
    return s32Ret;
}

HI_S32 PQ_DRV_GetHdrSatMap(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    CHECK_PTR_REINT(pu8Buffer);
    HI_PQ_HDR_SAT_MAP_S stSatMap;
    memset(&stSatMap, 0 , sizeof(stSatMap));
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_G_HDR_SAT_MAP, &stSatMap);
    CHECK_RETURN(s32Ret);
    memcpy(pu8Buffer, &stSatMap, sizeof(HI_PQ_HDR_SAT_MAP_S));
    return s32Ret;
}

HI_S32 PQ_DRV_SetHdrParaMode(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    CHECK_PTR_REINT(pu8Buffer);
...
HI_S32 PQ_DRV_GetHdrParaMode(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    CHECK_PTR_REINT(pu8Buffer);
...
HI_S32 PQ_DRV_SetHdrSoftPara(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_S_HDR_SOFT_PARA, pu8Buffer);
    return s32Ret;
}

HI_S32 PQ_DRV_GetHdrSoftPara(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;

    CHECK_PTR_REINT(pu8Buffer);

    HI_PQ_HDR_SOFT_PARA_S stSoftPara;
    memset(&stSoftPara, 0 , sizeof(stSoftPara));
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_G_HDR_SOFT_PARA, &stSoftPara);
    CHECK_RETURN(s32Ret);

    memcpy(pu8Buffer, &stSoftPara, sizeof(HI_PQ_HDR_SOFT_PARA_S));
    return s32Ret;
}

HI_S32 PQ_DRV_GetHdrSrcLum(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;

    CHECK_PTR_REINT(pu8Buffer);

    HI_PQ_HDR_SRC_LUM_S stSrcLum;
    memset(&stSrcLum, 0 , sizeof(stSrcLum));
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_G_HDR_SRC_LUM, &stSrcLum);
    CHECK_RETURN(s32Ret);

    memcpy(pu8Buffer, &stSrcLum, sizeof(HI_PQ_HDR_SRC_LUM_S));
    return s32Ret;
}
...
PQ_DBG_REG_TYPE_S stPQSetRegTypeFun[] =
{
    ...
    {PQ_CMD_VIRTUAL_HDR_PARA_MODE,       PQ_DRV_SetHdrParaMode},
    {PQ_CMD_VIRTUAL_HDR_SOFT_PARA,       PQ_DRV_SetHdrSoftPara},
    {PQ_CMD_VIRTUAL_HDR_TM_XPOS,         PQ_DRV_SetHdrTmXpos},
    {PQ_CMD_VIRTUAL_HDR_TONE_MAP,        PQ_DRV_SetHdrTmMap},
    {PQ_CMD_VIRTUAL_HDR_SAT_MAP,         PQ_DRV_SetHdrSatMap},
    {PQ_CMD_VIRTUAL_HDR_TM_YMAP,         PQ_DRV_SetHdrTmYmap},
    //{PQ_CMD_BUTT, NULL},
};
...
PQ_DBG_REG_TYPE_S stPQGetRegTypeFun[] =
{
    ...
    {PQ_CMD_VIRTUAL_HDR_PARA_MODE,       PQ_DRV_GetHdrParaMode},
    {PQ_CMD_VIRTUAL_HDR_SRC_LUM,         PQ_DRV_GetHdrSrcLum},
    {PQ_CMD_VIRTUAL_HDR_TM_XPOS,         PQ_DRV_GetHdrTmXpos},
    {PQ_CMD_VIRTUAL_HDR_SOFT_PARA,       PQ_DRV_GetHdrSoftPara},
    {PQ_CMD_VIRTUAL_HDR_TONE_MAP,        PQ_DRV_GetHdrTmMap},
    {PQ_CMD_VIRTUAL_HDR_SAT_MAP,         PQ_DRV_GetHdrSatMap},
    {PQ_CMD_VIRTUAL_HDR_TM_YMAP,         PQ_DRV_GetHdrTmYmap},
    //{PQ_CMD_BUTT, NULL},
};
...
typedef struct hiPQ_DRV_CHECKCMDLEN_S
{
    HI_U32 u32RegAddr;
    HI_U32 u32CmdLen;
} PQ_DRV_CHECKCMDLEN_S;


PQ_DRV_CHECKCMDLEN_S stPQDrvCheckCmdLen[] =
{
    ...
    {PQ_CMD_VIRTUAL_HDR_TM_XPOS,        sizeof(HI_PQ_HDR_TM_XPOS_S)     },
    {PQ_CMD_VIRTUAL_HDR_TM_YMAP,        sizeof(HI_PQ_HDR_TM_YMAP_S)     },
    {PQ_CMD_VIRTUAL_HDR_SRC_LUM,        sizeof(HI_PQ_HDR_SRC_LUM_S)     },
    {PQ_CMD_VIRTUAL_HDR_SOFT_PARA,      sizeof(HI_PQ_HDR_SOFT_PARA_S)   },
    {PQ_CMD_VIRTUAL_HDR_TONE_MAP,       sizeof(HI_PQ_HDR_TONE_MAP_S)    },
    {PQ_CMD_VIRTUAL_HDR_SAT_MAP,        sizeof(HI_PQ_HDR_SAT_MAP_S)     },
...
HI_S32 PQ_DRV_CheckCmd(HI_U32 u32RegAddr, HI_U32 u32Len)
{
    ...
    u32PQDrvCmdLenTotal = sizeof(stPQDrvCheckCmdLen) / sizeof(PQ_DRV_CHECKCMDLEN_S);
    for (u32PQDrvCmdIdex = 0; u32PQDrvCmdIdex < u32PQDrvCmdLenTotal; u32PQDrvCmdIdex++)
    {
        ...
        else if (u32RegAddr == stPQDrvCheckCmdLen[u32PQDrvCmdIdex].u32RegAddr )
        {
            ...
            {
                HI_ERR_PQ("PQ_DRV_CheckCmd Len No Match ! virtual address = 0x%x,u32Len = %d,u32CmdLen = %d\n", \
