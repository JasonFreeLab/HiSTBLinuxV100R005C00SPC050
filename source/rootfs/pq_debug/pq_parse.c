...
PQ_DBG_CMD_FUN_S stPQCmdFunction[] =
{
    ...
    {PQ_CMD_READ_HDR_TONE_MAP, HI_PQ_ReadRegs},
    {PQ_CMD_WRITE_HDR_TONE_MAP, HI_PQ_WriteRegs},
    {PQ_CMD_READ_HDR_SAT_MAP, HI_PQ_ReadRegs},
    {PQ_CMD_WRITE_HDR_SAT_MAP, HI_PQ_WriteRegs},
