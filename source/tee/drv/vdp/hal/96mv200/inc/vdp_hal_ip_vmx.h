...
typedef struct tee_hal_spinlock  T_SPINLOCK;
...
typedef struct VMX_CORE_PARAMETERS {
	...
	HI_U16 embedding_strength_threshold[48]; // 48 - to accommodate all 3 cases (8, 10, 12 bits scenarios)
	HI_U16 embedding_strength_threshold_bg[48];
...
HI_VOID VDP_VMX_SetVmxNoSecFlag(HI_U32 u32Data, HI_U32 u32Enable);
