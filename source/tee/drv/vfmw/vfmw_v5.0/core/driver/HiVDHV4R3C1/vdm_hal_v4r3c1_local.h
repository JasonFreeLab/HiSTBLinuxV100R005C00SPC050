#ifndef _VDM_HAL_V4R3C1_LOCAL_HEADER_
#define _VDM_HAL_V4R3C1_LOCAL_HEADER_
...
typedef struct
{
    ...
    USIGN bit_depth:                            4;
    USIGN reserved1:                            2;
} VDMRPMSG_V4R3C1_D7; //BitDepth像素位深，[8,14]，非8时不压缩

typedef struct
{
    USIGN ystride_nbit:                         20;
    USIGN reserved:                             12;
} VDMRPMSG_V4R3C1_D8;  //光栅格式，nbit相邻行跨度(16byte对齐,byte单位)

typedef struct
{
    USIGN yoffset_nbit:                         32;
} VDMRPMSG_V4R3C1_D9;  //光栅格式，亮度nbit相对亮度8bit偏移(16byte对齐)

typedef struct
{
    USIGN uvoffset_nbit:                        32;
} VDMRPMSG_V4R3C1_D10;  //光栅格式，色度nbit相对nbit偏移(16byte对齐)
...
typedef struct
{
    ...
    USIGN start_mby:                            9;
    USIGN reserved1:                            7;
} VDMRPMSG_V4R3C1_D12;  // D0 in Burst1 (VDH)
...
typedef struct
{
    ...
    USIGN end_mby:                              9;
    USIGN reserved1:                            7;
} VDMRPMSG_V4R3C1_D13;  // D1 in Burst1 (VDH)

typedef struct
{
    USIGN mbgrp_stuffing_type:                  2;
    USIGN reserved:                             30;
} VDMRPMSG_V4R3C1_D14;  // D2 in Burst1 (VDH)
...
typedef struct
{
    VDH_V4R3C1_START           *vdh_start;
    VDH_V4R3C1_REPAIR          *vdh_repair;
    BASIC_V4R3C1_CFG0          *basic_cfg0;
    BASIC_V4R3C1_CFG1          *basic_cfg1;
    AVM_V4R3C1_ADDR            *avm_addr;
    VAM_V4R3C1_ADDR            *vam_addr;
    STREAM_V4R3C1_BASE_ADDR    *stream_base_addr;
    YSTADDR_V4R3C1_1D          *ystaddr_1d;
    YSTRIDE_V4R3C1_1D          *ystride_1d;
    UVOFFSET_V4R3C1_1D         *uvoffset_1d;
    HEAD_V4R3C1_INF_OFFSET     *head_inf_offset;
    VDH_V4R3C1_STATE           *vdh_state;
    INT_V4R3C1_STATE           *int_state;
    INT_V4R3C1_MASK            *int_mask;
    REF_V4R3C1_PIC_TYPE        *RefPicType;
    FF_V4R3C1_APT_EN           *FfAptEn;
} VDMHAL_V4R3C1_REGINF_S;

typedef struct
{
    VDMRPMSG_V4R3C1_D0   *d0;
    VDMRPMSG_V4R3C1_D1   *d1;
    VDMRPMSG_V4R3C1_D2   *d2;
    VDMRPMSG_V4R3C1_D3   *d3;
    VDMRPMSG_V4R3C1_D4   *d4;

    VDMRPMSG_V4R3C1_D8   *d8[MAX_UP_MSG_SLICE_NUM];  // D0 in Burst1 (VDH)
    VDMRPMSG_V4R3C1_D9   *d9[MAX_UP_MSG_SLICE_NUM];  // D1 in Burst1 (VDH)
    VDMRPMSG_V4R3C1_D10   *d10[MAX_UP_MSG_SLICE_NUM];  // D2 in Burst1 (VDH)
} VDMHAL_V4R3C1_RPMSGINF_S;
