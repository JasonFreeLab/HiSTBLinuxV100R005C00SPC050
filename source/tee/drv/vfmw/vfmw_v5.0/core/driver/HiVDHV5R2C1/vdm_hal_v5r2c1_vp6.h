#ifndef __VDM_HAL_V5R2C1_VP6_H__
#define __VDM_HAL_V5R2C1_VP6_H__
...
typedef struct
{
    USIGN dec_start:                            1;
    USIGN reserved:                             31;
} VP6_V5R2C1_VDH_START;

typedef struct
{
    USIGN repair_start:                         1;
    USIGN reserved:                             31;
} VP6_V5R2C1_VDH_REPAIR;
...
typedef struct
{
    ...
    USIGN AcQuant:                              9;
    USIGN reserved:                             11;
} VP6_V5R2C1_DWNMSG_D4;

typedef struct
{
    USIGN value:                                32;
} VP6_V5R2C1_DWNMSG_D8;
...
typedef struct
{
    ...
    USIGN count:                                4;
    USIGN reserved1:                            12;
} VP6_V5R2C1_DWNMSG_D9;

typedef struct
{
    USIGN bit0_len_0:                           25;
    USIGN bit0_offset_0:                        7;
} VP6_V5R2C1_DWNMSG_D16;

typedef struct
{
    USIGN bit0_stream_addr_0:                   24;
    USIGN reserved:                             8;
} VP6_V5R2C1_DWNMSG_D17;

typedef struct
{
    USIGN bit0_len_1:                           25;
    USIGN bit0_offset_1:                        7;
} VP6_V5R2C1_DWNMSG_D18;

typedef struct
{
    USIGN bit0_stream_addr_1:                   24;
    USIGN reserved:                             8;
} VP6_V5R2C1_DWNMSG_D19;

typedef struct
{
    USIGN bit1_len_0:                           25;
    USIGN bit1_offset_0:                        7;
} VP6_V5R2C1_DWNMSG_D20;

typedef struct
{
    USIGN bit1_stream_addr_0:                   24;
    USIGN reserved:                             8;
} VP6_V5R2C1_DWNMSG_D21;

typedef struct
{
    USIGN bit1_len_1:                           25;
    USIGN bit1_offset_1:                        7;
} VP6_V5R2C1_DWNMSG_D22;

typedef struct
{
    USIGN bit1_stream_addr_1:                   24;
    USIGN reserved:                             8;
} VP6_V5R2C1_DWNMSG_D23;

typedef struct
{
    USIGN curr_rcn_addr:                        32;
} VP6_V5R2C1_DWNMSG_D32;

typedef struct
{
    USIGN golden_ref_addr:                      32;
} VP6_V5R2C1_DWNMSG_D34;

typedef struct
{
    USIGN last_ref_addr:                        32;
} VP6_V5R2C1_DWNMSG_D35;

typedef struct
{
    USIGN sed_top_addr:                         32;
} VP6_V5R2C1_DWNMSG_D36;

typedef struct
{
    USIGN pmv_top_addr:                         32;
} VP6_V5R2C1_DWNMSG_D37;

typedef struct
{
    USIGN rcn_top_addr:                         32;
} VP6_V5R2C1_DWNMSG_D38;

typedef struct
{
    USIGN tab_addr:                              32;
} VP6_V5R2C1_DWNMSG_D39;
...
SINT32 VP6HAL_V5R2C1_InitHal(UADDR CodeTabAddr);
SINT32 VP6HAL_V5R2C1_StartDec(VP6_DEC_PARAM_S *pVp6sDecParam, SINT32 VdhId, VOID *pTask);
SINT32 VP6HAL_V5R2C1_CfgReg(VP6_DEC_PARAM_S *pVp6DecParam, VDMHAL_HWMEM_S *pHwMem , SINT32 VdhId, VOID *pTask);
SINT32 VP6HAL_V5R2C1_CfgDnMsg(VP6_DEC_PARAM_S *pVp6DecParam, VDMHAL_HWMEM_S *pHwMem , SINT32 VdhId);
