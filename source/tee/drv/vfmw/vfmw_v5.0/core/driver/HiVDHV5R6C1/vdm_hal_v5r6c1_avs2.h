#ifndef __VDM_HAL_V5R6C1_AVS2_H__
#define __VDM_HAL_V5R6C1_AVS2_H__
...
typedef struct
{
    ...
    UINT32 rsv:                      23;
} AVS2_V5R6C1_DWNMSG_D3;

typedef struct
{
    UINT32 bwd_address:            32;
} AVS2_V5R6C1_DWNMSG_D4;

typedef struct
{
    UINT32 fwd_address_0:            32;
} AVS2_V5R6C1_DWNMSG_D5;

typedef struct
{
    UINT32 fwd_address_1:            32;
} AVS2_V5R6C1_DWNMSG_D6;

typedef struct
{
    UINT32 rcn_address:              32;
} AVS2_V5R6C1_DWNMSG_D7;
...
typedef struct
{
    ...
    UINT32 rsv1:                     6;
} AVS2_V5R6C1_DWNMSG_D8;

typedef struct
{
    UINT32 bit_stream_address_0:     24;
    UINT32 rsv:                      8;
} AVS2_V5R6C1_DWNMSG_D9;
...
typedef struct
{
    ...
    UINT32 rsv:                      1;
} AVS2_V5R6C1_DWNMSG_D10;

typedef struct
{
    UINT32 bit_stream_address_1:     24;
    UINT32 rsv:                      8;
} AVS2_V5R6C1_DWNMSG_D11;
...
typedef struct
{
    ...
    UINT32 rsv:                      1;
#endif
} AVS2_V5R6C1_DWNMSG_D12;

typedef struct
{
    UINT32 pmv_top_addr:         32;
} AVS2_V5R6C1_DWNMSG_D13;

typedef struct
{
    UINT32 topmb_intra_addr:         32;
} AVS2_V5R6C1_DWNMSG_D14;

typedef struct
{
    UINT32 colpic_mv_addr:           32;
} AVS2_V5R6C1_DWNMSG_D16;

typedef struct
{
    UINT32 pmv_cfg_table:           32;
} AVS2_V5R6C1_DWNMSG_D17_48;

typedef struct
{
    UINT32 pmv_colmb_addr:           32;
} AVS2_V5R6C1_DWNMSG_D49;
typedef struct
{
    UINT32 dblk_top_addr:         32;
} AVS2_V5R6C1_DWNMSG_D50;
typedef struct
{
    UINT32 sed_top_addr:         32;
} AVS2_V5R6C1_DWNMSG_D51;
...
SINT32 AVS2HAL_V5R6C1_InitHal(SINT32 CodeTabAddr);
SINT32 AVS2HAL_V5R6C1_StartDec(AVS2_DEC_PARAM_S *pAvsDecParam, SINT32 VdhId, VOID *pTask);
