#ifndef __VDM_HAL_V5R6C1_MPEG2_H__
#define __VDM_HAL_V5R6C1_MPEG2_H__
...
typedef struct
{
    ...
    USIGN bit_offset_0:                         7;
    USIGN reserved:                             1;
} MP2SLCDNMSG_V5R6C1_D0;

typedef struct
{
    USIGN bit_stream_address_0:               24;
    USIGN reserved:                             8;
} MP2SLCDNMSG_V5R6C1_D1;
...
typedef struct
{
    ...
    USIGN bit_offset_1:                         7;
    USIGN reserved:                             1;
} MP2SLCDNMSG_V5R6C1_D2;

typedef struct
{
    USIGN bit_stream_address_1:               24;
    USIGN reserved:                             8;
} MP2SLCDNMSG_V5R6C1_D3;
...
typedef struct
{
    ...
    USIGN intra_slice:                         1;
    USIGN reserved:                            25;
} MP2SLCDNMSG_V5R6C1_D4;

typedef struct
{
    USIGN slice_start_mbn:                     20;
    USIGN reserved:                             12;
} MP2SLCDNMSG_V5R6C1_D5;

typedef struct
{
    USIGN slice_end_mbn:                       20;
    USIGN reserved:                             12;
} MP2SLCDNMSG_V5R6C1_D6;

typedef struct
{
    USIGN next_slice_para_addr:               32;
} MP2SLCDNMSG_V5R6C1_D7;


//MPEG2消息池结构体
typedef struct
{
    MP2DNMSG_V5R6C1_D0     *d0;
    MP2DNMSG_V5R6C1_D1     *d1;
    MP2DNMSG_V5R6C1_D2     *d2;
    MP2DNMSG_V5R6C1_D3     *d3;
    MP2DNMSG_V5R6C1_D4     *d4;
    MP2DNMSG_V5R6C1_D5     *d5;
    MP2DNMSG_V5R6C1_D6     *d6;
    MP2DNMSG_V5R6C1_D7     *d7;
    MP2DNMSG_V5R6C1_D8     *d8;
    MP2DNMSG_V5R6C1_D9     *d9;
    MP2DNMSG_V5R6C1_D10    *d10;
    MP2DNMSG_V5R6C1_D11    *d11;
    MP2DNMSG_V5R6C1_D16_31 *dmatrix_intra[32];
    MP2DNMSG_V5R6C1_D32_47 *dmatrix_non_intra[32];
    MP2DNMSG_V5R6C1_D48    *d48;
    MP2DNMSG_V5R6C1_D63    *d63;
} MP2_V5R6C1_DNMSGINF_S;

typedef struct
{
    MP2UPMSG_V5R6C1_D1     *d1[MAX_UP_MSG_SLICE_NUM];
...
SINT32 MP2HAL_V5R6C1_StartDec( MP2_DEC_PARAM_S *pMp2DecParam, SINT32 VdhId, VOID *pTask);
