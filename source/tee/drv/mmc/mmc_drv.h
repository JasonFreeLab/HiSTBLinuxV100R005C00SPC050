...
#define TEE_EMMC_CODE_FLAG				false

#define MOULE_NAME					"emmc_drv:"
#define printf						tee_hal_printf
#define udelay(x)					TEE_DRV_DelayUs(x)
#define mdelay(msec)				tee_hal_mdelay(msec)
