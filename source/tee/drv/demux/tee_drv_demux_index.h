 ...
 ************************************************************************/
HI_S32  FIDX_Init(HI_VOID (*OutputFramePosition)(HI_U32 *Param, FRAME_POS_S *pstScInfo));
HI_S32  FIDX_DeInit(HI_VOID);
