...
typedef struct hiTEE_HDMI_HAL_S
{
    ...
    HI_VOID (*TEE_HAL_HDMI_HdcpStreamTypeSet)(struct hiTEE_HDMI_HAL_S *pstTeeHdmiHal, HI_DRV_HDMI_HDCP_STREAM_TYPE_E enStreamType);
    ...
    HI_VOID (*TEE_HAL_HDMI_Hdcp2AuthStart)(struct hiTEE_HDMI_HAL_S *pstTeeHdmiHal, HI_S32 s32Start);
    ...
    HI_S32 (*TEE_HAL_HDMI_DownScalSet)(struct hiTEE_HDMI_HAL_S *pstTeeHdmiHal,HI_U32 u32DownScalWidth,HI_U32 u32DownScalHeight);
    ...
    HI_S32 (*TEE_HAL_HDMI_Hdcp14EncrpytionEanble)(struct hiTEE_HDMI_HAL_S *pstTeeHdmiHal,HI_S32 s32Enable);
    HI_S32 (*TEE_HAL_HDMI_Hdcp14RepeaterEnable)(struct hiTEE_HDMI_HAL_S *pstTeeHdmiHal,HI_S32 s32Enable);
