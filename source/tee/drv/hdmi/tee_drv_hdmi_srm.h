...
HI_S32 HDMI_CheckDevIdIsValid(HDMI_SRM_CTX_S *pstSrm, HDMI_HDCP_DEVID_S *pstDevId);
HI_S32 HDMI_CheckDevIdListIsValid(HDMI_SRM_CTX_S *pstSrm, HDMI_HDCP_REPEAT_IDLIST_S *pstDevIdList);
