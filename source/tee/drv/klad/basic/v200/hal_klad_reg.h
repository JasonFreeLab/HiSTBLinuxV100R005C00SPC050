...
#define KL_ROB_ALARM                (KL_BASE_ADDR + 0x20)     //Hisec key ladde

#define KL_COM_KLAD_DIN0            (KL_BASE_ADDR + 0x00)    //normal CPU config data in register 0
#define KL_COM_KLAD_DIN1            (KL_BASE_ADDR + 0x04)    //normal CPU  data in register 1
#define KL_COM_KLAD_DIN2            (KL_BASE_ADDR + 0x08)    //normal CPU  data in register 2
#define KL_COM_KLAD_DIN3            (KL_BASE_ADDR + 0x0C)    //normal CPU  data in register 3
