#ifndef _TEE_DRV_TZASC_V200_H_
#define _TEE_DRV_TZASC_V200_H_

#define _SEC_BYPASS_BITS_CHIP                    (4)

#define _SEC_RGN_BASE_ADDR_BITS_CHIP             (24)
#define _SEC_RGN_SIZE_SHIFT_CHIP                 (24)
#define _SEC_RGN_SIZE_BITS_CHIP                  (6)
#define _SEC_RGN_SP_SHIFT_CHIP                   (0)
#define _SEC_RGN_SP_BITS_CHIP                    (4)

#define _SEC_SHARE_RGN_FAIL_CMDID_BITS_CHIP      (9)
#define _SEC_SHARE_RGN_FAIL_MID_SHIFT_CHIP       (12)

#define _SEC_LOCKDOWN_SEL_CFG_CHIP  (0xFF1F1F)
...
#define TZASC_SP_NON_SEC	0xB
#define TZASC_SP_SEC		0xc
#define TZASC_SP_FULL		0xf
