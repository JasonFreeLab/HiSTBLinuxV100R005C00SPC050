...
/**CNcomment:Key安全模式类型*/
typedef enum hiUNF_DMX_KEY_SECURE_MODE_E
{
    HI_TEE_DMX_KEY_SECURE_MODE_TEE = 0,        /** <trustedzone security protection*/ /**<CNcomment:trustedzone安全保护*/
    HI_TEE_DMX_KEY_SECURE_MODE_NONE,           /** <no security protection*/ /**<CNcomment:无安全保护*/

    HI_TEE_DMX_KEY_SECURE_MODE_BUTT
} HI_TEE_DMX_KEY_SECURE_MODE_E;
...
typedef enum hiTEE_DMX_DESCRAMBLER_TYPE_E
{
    ...
    HI_TEE_DMX_DESCRAMBLER_TYPE_AES_NS    ,          /**<AES NS-Mode, AES NOVEL*/
    HI_TEE_DMX_DESCRAMBLER_TYPE_SMS4_NS   ,          /**<SMS4 NS-Mode, SMS4 NOVEL*/
    ...
    HI_TEE_DMX_DESCRAMBLER_TYPE_DES_IPTV,            /**<DES IPTV*/
    HI_TEE_DMX_DESCRAMBLER_TYPE_TDES_IPTV,           /**<TDES IPTV*/
    HI_TEE_DMX_DESCRAMBLER_TYPE_TDES_ECB,            /**<TDES ECB */
    HI_TEE_DMX_DESCRAMBLER_TYPE_TDES_CBC,            /**<TDES CBC */
    HI_TEE_DMX_DESCRAMBLER_TYPE_AES_ECB_L,           /**<AES_ECB_L the clear stream left in the leading */
    HI_TEE_DMX_DESCRAMBLER_TYPE_AES_CBC_L,           /**<AES_CBC_L the clear stream left in the leading */
    HI_TEE_DMX_DESCRAMBLER_TYPE_ASA,                 /**<ASA 64/128 Algorithm only for NOC3.X */
    HI_TEE_DMX_DESCRAMBLER_TYPE_AES_CTR,             /**<AES CTR */
...
typedef struct hiTEE_DMX_DESCRAMBLER_ATTR_S
{
    ...
    HI_TEE_DMX_KEY_SECURE_MODE_E enKeySecureMode;     /**<Secure indication*/ /**<CNcomment:安全标示*/
...
\see \n
 N/A.CNcomment:无。CNend
*/
HI_S32 HI_TEE_DMX_SetDescramblerAttr(HI_HANDLE hKey, const HI_TEE_DMX_DESCRAMBLER_ATTR_S *pstAttr);
