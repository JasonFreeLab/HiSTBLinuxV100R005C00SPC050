...
typedef enum hiTEE_DMX_SCRAMBLER_TYPE_E
{
    ...
    HI_TEE_DMX_SCRAMBLER_TYPE_TDES_IPTV,           /**<TDES IPTV*/
    HI_TEE_DMX_SCRAMBLER_TYPE_TDES_ECB,            /**<TDES ECB*/
    HI_TEE_DMX_SCRAMBLER_TYPE_TDES_CBC,            /**<TDES CBC*/
    HI_TEE_DMX_SCRAMBLER_TYPE_AES_ECB_L,           /**<AES_ECB_L the clear stream left in the leading */
    HI_TEE_DMX_SCRAMBLER_TYPE_AES_CBC_L,           /**<AES_CBC_L the clear stream left in the leading */
    HI_TEE_DMX_SCRAMBLER_TYPE_ASA,                 /**<ASA 64/128 Algorithm only for NOC3.X */
    HI_TEE_DMX_SCRAMBLER_TYPE_AES_CTR,             /**<AES TR */
