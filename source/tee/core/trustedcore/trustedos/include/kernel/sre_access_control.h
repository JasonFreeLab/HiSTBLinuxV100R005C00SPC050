...
#define SYSCALL_END   break;  } \
                ...
                tloge("[ERROR!!!] permission denied to access swi_id 0x%x, please check sre_syscalls_id.h to get more info\n", swi_id); \
                break; } }
...
#define RPMB_UPDATE_PERMISSION		0x2000000LL
...
/**/
#define GT_PERMISSIONS (CONSOLE_GROUP_PERMISSION | SMC_GROUP_PERMISSION | MM_GROUP_PERMISSION | TASK_GROUP_PERMISSION | KVAR_GROUP_PERMISSION | MEMORY_GROUP_PERMISSION | HDCP_GROUP_PERMISSION | TUI_GROUP_PERMISSION)
