...
#ifdef LOG_ON
#define tlogv(fmt, args...) printk(LOG_LEVEL_ON, "%s %s:" fmt "", VERB_TAG, __func__, ## args)
#define tlogd(fmt, args...) printk(LOG_LEVEL_ON, "%s %s:" fmt "", DEBUG_TAG, __func__, ## args)
#define tlogi(fmt, args...) printk(LOG_LEVEL_ON, "%s %s:" fmt "", INFO_TAG, __func__, ## args)
#define tlogw(fmt, args...) printk(LOG_LEVEL_ON, "%s %s:" fmt "", WARN_TAG, __func__, ## args)
#else
