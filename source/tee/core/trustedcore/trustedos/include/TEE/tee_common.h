...
enum global_service_cmd_id {
	...
	GLOBAL_CMD_ID_BOOT_ACK = 0x1,         /**< Global Task 启动应答*/
	GLOBAL_CMD_ID_OPEN_SESSION = 0x2,     /**< Global Task 打开Session*/
	GLOBAL_CMD_ID_CLOSE_SESSION = 0x3,    /**< Global Task 关闭Session*/
	GLOBAL_CMD_ID_LOAD_SECURE_APP = 0x4,  /**< Global Task 动态加载安全应用*/
	GLOBAL_CMD_ID_NEED_LOAD_APP = 0x5,    /**< Global Task 判断是否是需要加载安全应用*/
	GLOBAL_CMD_ID_REGISTER_AGENT = 0x6,   /**< Global Task 注册代理*/
	GLOBAL_CMD_ID_UNREGISTER_AGENT = 0x7, /**< Global Task 注销代理*/
	GLOBAL_CMD_ID_REGISTER_NOTIFY_MEMORY = 0x8,   /**< Global Task 注册异步调用缓冲区*/
	GLOBAL_CMD_ID_UNREGISTER_NOTIFY_MEMORY = 0x9, /**< Global Task 注销异步调用缓冲区*/
	GLOBAL_CMD_ID_INIT_CONTENT_PATH = 0xa,      /**< Global Task初始化content path*/
	GLOBAL_CMD_ID_TERMINATE_CONTENT_PATH= 0xb,   /**< Global Task释放content path*/
	GLOBAL_CMD_ID_ALLOC_EXCEPTION_MEM = 0xc,  /**< Global Task 分配异常信息保存空间*/
	GLOBAL_CMD_ID_TEE_TIME = 0xd,         /**< Global Task 获取安全OS的时间 */
	GLOBAL_CMD_ID_TEE_INFO = 0xe,        /** tlogcat 获取安全OS  状态 */
	GLOBAL_CMD_ID_REGISTER_RDR_MEM = 0xf, /**注册RDR 内存*/
