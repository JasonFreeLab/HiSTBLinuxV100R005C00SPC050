...
#add by sdk, set globaltask relocation info to image header
elf_class = 0
...
if __name__ == '__main__':
  ...
  global_img_strtab_size = int(global_sym_item[2]) - global_img_symtab_size;
  ...
  pubKeyFile = pwd_path + '/tools/rsa_public_key_stb.pem'
  if CompareImage == 0:
