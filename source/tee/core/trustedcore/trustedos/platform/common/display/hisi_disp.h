...
extern int tee_mutex_init(const char *name, unsigned int size, TEE_MUTEX_HANDLE *handle);
extern int tee_mutex_lock(TEE_MUTEX_HANDLE handle);
extern int tee_mutex_lock_wait(TEE_MUTEX_HANDLE handle);
extern int tee_mutex_unlock(TEE_MUTEX_HANDLE handle);
extern void tee_mutex_release(TEE_MUTEX_HANDLE handle);
