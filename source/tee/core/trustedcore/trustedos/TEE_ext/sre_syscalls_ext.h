...
extern int __init_ttf_mem_info(void *ttf_mem_addr);
extern int __get_ttf_mem_info(void *ttf_mem_addr);
extern int __unmap_ttf_mem(unsigned int addr, unsigned int size);
extern int __set_cursor_flag();
extern int __tee_hal_get_dieid(unsigned int *pBuffer);
#ifdef TEE_SUPPORT_SE
extern int __scard_connect(int reader_id, void *p_atr, unsigned int *atr_len);
extern int __scard_disconnect(int reader_id);
extern int __scard_transmit(int reader_id, unsigned char *p_cmd , unsigned int cmd_len,
			      unsigned char *p_rsp , unsigned int *rsp_len);
extern int __scard_support_mode(void);
...
/*hi_vcodec*/
extern int __SEC_VDEC_Init(unsigned int *Args, unsigned int ArgsLen, unsigned int *Share, unsigned int shareLen);
...
extern int __SEC_VDEC_ReleaseChanImage(int ChanID, unsigned int Image_h, unsigned int Image_l);
#endif
