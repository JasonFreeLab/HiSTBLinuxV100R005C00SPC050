...
EXPORT_SYMBOL(TEE_TUINotify_fp);
...
#endif
extern TA_rpmb_threshold_t ta_rpmb_threshold_config[];
extern uint32_t g_rpmb_ta_num;
extern TA_permission_t rpmb_permission_config[];
extern uint32_t g_rpmb_permission_num;

EXPORT_DATA_SYMBOL(ta_rpmb_threshold_config);
EXPORT_DATA_SYMBOL(g_rpmb_ta_num);
EXPORT_DATA_SYMBOL(rpmb_permission_config);
EXPORT_DATA_SYMBOL(g_rpmb_permission_num);

extern void tee_rpmb_get_key_type(uint32_t *key_type);
extern void tee_rpmb_get_meta_type(uint32_t *meta_type);


EXPORT_SYMBOL(tee_rpmb_get_key_type);
EXPORT_SYMBOL(tee_rpmb_get_meta_type);
