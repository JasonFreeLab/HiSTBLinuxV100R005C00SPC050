...
// History       :  xxx 2017/06/01 11:06:38 Create file
// ******************************************************************************
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    pcie_srst_req         : 1   ; /* [6]  */
        unsigned int    pcie_refclk_sel       : 1   ; /* [7]  */
        unsigned int    wifi_clk_ctrl         : 3   ; /* [10..8]  */
...
typedef union
{
    ...
    /* Define the struct bits s for Hi3798MV210*/
    struct
    {
        unsigned int    vo_bp_cken            : 1   ; /* [0]  */
        unsigned int    vdp_g4_cken           : 1   ; /* [1]  */
...
typedef union
{
    ...
    struct
    {
        unsigned int    fracdiv_deno          : 12  ; /* [11..0]  */
        unsigned int    fracdiv_num           : 12  ; /* [23..12]  */
        unsigned int    fracdiv_integer       : 7   ; /* [30..24]  */
        unsigned int    fracdiv_en            : 1   ; /* [31]  */
    } bits;
