...
#ifdef HI_TWOSTAGEBOOT_SUPPORT
extern HI_S32 HI_FIRSTBOOT_SSA_Entry(HI_U32 u32Address, HI_U32 u32Length);
#else
...
#if defined(HI_ADVCA_VERIFY_ENABLE) && defined(HI_ADVCA_SUPPORT)
#ifdef HI_TWOSTAGEBOOT_SUPPORT
    HI_FIRSTBOOT_SSA_Entry(CFG_SECONDBOOT_ADDR, CFG_SECONDBOOT_SIZE);
#else
#ifdef HI_ANDROID_BOOT_SUPPORT
    set_default_ethaddr();
#endif
