...
SYSREG = $(SYSREGDIR)/$(BOOTCONFIG)/$(CFG_HI_BOOT_REG_NAME)
else
...
SBL = $(if $(CFG_HI_TEE_VMX_ULTRA_SUPPORT),y,)
...
ifeq ($(CFG_HI_BOOT_ENV_STARTADDR),0)
	@$(CONFIG_EXPORT) "CONFIG_TWOSTAGEBOOT_SUPPORT=$(CFG_HI_TWOSTAGEBOOT_SUPPORT)" \
		"Support secondboot" $@
endif
endif
#+++++++++++++++++++++ unified boot +++++++++++++++++++++++++++++++++++++++++++++
...
ifeq ($(CFG_HI_NAND_FLASH_SUPPORT),y)
ifneq ($(CFG_HI_TWOSTAGEBOOT_SUPPORT),y)
	$(AT)rm -rf $(HI_NAND_IMAGE_DIR)/fastboot.bin
else
	$(AT)rm -rf $(HI_NAND_IMAGE_DIR)/fastboot.bin
	$(AT)rm -rf $(HI_NAND_IMAGE_DIR)/secondboot.bin
endif
endif
ifeq ($(CFG_HI_SPI_SUPPORT),y)
	$(AT)rm -rf $(HI_SPI_IMAGE_DIR)/fastboot.bin
endif
ifeq ($(CFG_HI_EMMC_SUPPORT),y)
	$(AT)rm -rf $(HI_EMMC_IMAGE_DIR)/fastboot.bin
endif
ifeq ($(CFG_HI_SPI_SUPPORT)_$(CFG_HI_EMMC_SUPPORT),y_y)
	$(AT)rm -rf $(HI_SPI_EMMC_IMAGE_DIR)/fastboot.bin
endif
ifeq ($(OBJ_DIR),)
