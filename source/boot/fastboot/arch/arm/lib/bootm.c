...
int do_bootm_linux(int flag, int argc, char *argv[], bootm_headers_t *images)
{
...
#ifdef CONFIG_SBL
	{
		...
		if (image_check_arch (hdr, IH_ARCH_ARM64)) {
			...
			printf("Move bl33 from 0x%lx to 0x%lx, %lu Bytes\n", (u32)theKernel, cmd_args.arg2, cmd_args.arg3);
			memmove((void *)cmd_args.arg2, (void *)(u32)theKernel, cmd_args.arg3);
			...
			*/
			printf("Move dtb from 0x%lx to 0x%lx, %lu Bytes\n", cmd_args.arg1, cmd_args.arg4, cmd_args.arg5);
			memmove((void *)cmd_args.arg4, (void *)cmd_args.arg1, cmd_args.arg5);
