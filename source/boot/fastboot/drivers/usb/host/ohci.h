...
typedef struct ohci_device {
	ed_t ed[NUM_EDS] __attribute__((aligned(ED_ALIGNMENT)));
	td_t tds[NUM_TD] __attribute__((aligned(TD_ALIGNMENT)));
	int ed_cnt;
} ohci_dev_t;
...
typedef struct ohci {
	...
	struct ohci_device ohci_dev __attribute__((aligned(TD_ALIGNMENT)));
