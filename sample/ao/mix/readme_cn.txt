...
例    子: ./sample_mixengine a.wav 100 48000 1 b.wav 100 48000 1


功能描述: 展示音频多路track混音功能（track绑定avplay）
命令格式: ./sample_audio_mix freq srate inputfile0 type0 inputfile1 type1 ...
参数说明：freq 频点频率  单位 KHz
	  srate 符号率
          ...
          type1        第1个输入文件的编码类型       
例    子: ./sample_audio_mix 618 6187 a.mp3 mp3 b.aac aac
