...
HI_S32 PKCS_PRI_ENC(HI_UNF_CIPHER_RSA_ENC_SCHEME_E enScheme)
{
 ...
 //       stRsaEnc.stPriKey.pu8D = (HI_U8*)malloc(256);
    	...
    	*/
    	memcpy(stRsaEnc.stPriKey.pu8N, N, 128);
        memcpy(stRsaEnc.stPriKey.pu8E, E, 128);
    	memcpy(stRsaEnc.stPriKey.pu8P, P, 64);
        memcpy(stRsaEnc.stPriKey.pu8Q, Q, 64);
        
        stRsaEnc.stPriKey.u16NLen = 128;
        stRsaEnc.stPriKey.u16ELen = 128;
        stRsaEnc.stPriKey.u16PLen = 64;
        stRsaEnc.stPriKey.u16QLen = 64;
        stRsaEnc.stPriKey.u16DPLen = 64;
        stRsaEnc.stPriKey.u16DQLen = 64;
        stRsaEnc.stPriKey.u16QPLen = 64;
...
//        printBuffer ("QP", stRsaEnc.stPriKey.pu8QP, stRsaEnc.stPriKey.u16QPLen);
        ...
        ret = HI_UNF_CIPHER_RsaComputeCrtParams(1024, 0x11, stRsaEnc.stPriKey.pu8P, 
