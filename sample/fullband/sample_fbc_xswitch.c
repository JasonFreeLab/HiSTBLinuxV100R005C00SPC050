...
//   HI_HANDLE hTrack;
    ...
    for ( i = 0 ; i < HI_TUNER_NUMBER ; i++ )
    {
        ...
        case HI_UNF_DMX_PORT_TSI_0:
            ...
            stDmxPortAttr.enSerialPortShareClk = HI_TSI0_SERIAL_SHARE_CLK;
            break;
        case HI_UNF_DMX_PORT_TSI_1:
            ...
            stDmxPortAttr.enSerialPortShareClk = HI_TSI1_SERIAL_SHARE_CLK;
            break;
        case HI_UNF_DMX_PORT_TSI_2:
            ...
            stDmxPortAttr.enSerialPortShareClk = HI_TSI2_SERIAL_SHARE_CLK;
            break;
        case HI_UNF_DMX_PORT_TSI_3:
            ...
            stDmxPortAttr.enSerialPortShareClk = HI_TSI3_SERIAL_SHARE_CLK;
            break;
        case HI_UNF_DMX_PORT_TSI_4:
            ...
            stDmxPortAttr.enSerialPortShareClk = HI_TSI4_SERIAL_SHARE_CLK;
            break;
        case HI_UNF_DMX_PORT_TSI_5:
            ...
            stDmxPortAttr.enSerialPortShareClk = HI_TSI5_SERIAL_SHARE_CLK;
            break;
        }
