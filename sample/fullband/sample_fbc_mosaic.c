...
HI_S32 main(HI_S32 argc,HI_CHAR *argv[])
{
    ...
    for ( i = 0 ; i < HI_TUNER_NUMBER ; i++ )
    {
        ...
        case HI_UNF_DMX_PORT_TSI_0:
            ...
            g_stDmxPortAttr[i].enSerialPortShareClk = HI_TSI0_SERIAL_SHARE_CLK;
            break;
        case HI_UNF_DMX_PORT_TSI_1:
            ...
            g_stDmxPortAttr[i].enSerialPortShareClk = HI_TSI1_SERIAL_SHARE_CLK;
            break;
        case HI_UNF_DMX_PORT_TSI_2:
            ...
            g_stDmxPortAttr[i].enSerialPortShareClk = HI_TSI2_SERIAL_SHARE_CLK;
            break;
        case HI_UNF_DMX_PORT_TSI_3:
            ...
            g_stDmxPortAttr[i].enSerialPortShareClk = HI_TSI3_SERIAL_SHARE_CLK;
            break;
        case HI_UNF_DMX_PORT_TSI_4:
            ...
            g_stDmxPortAttr[i].enSerialPortShareClk = HI_TSI4_SERIAL_SHARE_CLK;
            break;
        case HI_UNF_DMX_PORT_TSI_5:
            ...
            g_stDmxPortAttr[i].enSerialPortShareClk = HI_TSI5_SERIAL_SHARE_CLK;
            break;
        }
