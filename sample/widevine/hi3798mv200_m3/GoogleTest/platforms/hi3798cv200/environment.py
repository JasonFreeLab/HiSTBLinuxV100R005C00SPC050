...
cdm_cflags += '-I'+platform_top+'out/hi3798cv200/hi3798cv2dmb_tee/include '
print '----------------cdm_cflags = %s' % cdm_cflags

cdm_cxxflags =  '-DZLIB_SHARED -DZLIB -DOPENSSL_THREADS  '
cdm_cxxflags += '-I'+platform_top+'out/hi3798cv200/hi3798cv2dmb_tee/include '
...
cdm_ldflags =  '-L'+platform_top+'out/hi3798cv200/hi3798cv2dmb_tee/lib/share '
cdm_ldflags += '-L'+platform_top+'out/hi3798cv200/hi3798cv2dmb_tee/obj/source/rootfs/protobuf/lib '
cdm_ldflags += '-L'+platform_top+'out/hi3798cv200/hi3798cv2dmb_tee/lib/static '
