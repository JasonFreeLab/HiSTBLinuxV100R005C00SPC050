...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../cdm/androidn/libwvdrmengine/oemcrypto/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../liboemcrypto/teec
LOCAL_MODULE := sample_keybox
LOCAL_MULTILIB := 32
LOCAL_MODULE_TAGS := optional
LOCAL_SHARED_LIBRARIES += liblog libcutils libutils libdl libm libhi_common libteec libhi_msp libhisysmanagerclient liboemcrypto
...
LOCAL_C_INCLUDES += $(MSP_DRV_INCLUDE)
LOCAL_C_INCLUDES += $(MSP_API_INCLUDE)
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../proprietary/oemcrypto
