...
NativeDisplay NATIVE_CreateDisplay(void)
{
#if defined (EGL_API_HIGO)
    HI_S32 s32Ret;
...
void NATIVE_DestroyDisplay(NativeDisplay display)
{
#if defined (EGL_API_HIGO)
...
NativeWindow NATIVE_CreateWindow(const char *title, int width, int height, EGLint visualId)
{
#if defined (EGL_API_HIGO)
    HI_S32 s32Ret;
    HI_HANDLE hWnd;
...
#if 0
NativePixmap NATIVE_CreatePixmap(int width, int height, EGLint visualId)
{
#if defined (EGL_API_HIGO)
    HI_S32 s32Ret;
    HI_HANDLE hSur;
...
void NATIVE_DestroyPixmap(NativePixmap pixmap)
{
#if defined (EGL_API_HIGO)
