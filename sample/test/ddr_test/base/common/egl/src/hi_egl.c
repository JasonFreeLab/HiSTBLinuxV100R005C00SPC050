...
static HI_S32 hi_egl_setlayerpara(HI_U32 width, HI_U32 height)
{
    ...
    **/
    ...
    stAlpha.u8Alpha1 = 0x70;
    stAlpha.u8GlobalAlpha = 0x70;
                    ...
                    EGLint bES20)
{
    ...
    /**===========================================================**/
    g_NativeDisplay = (NativeDisplayType)NATIVE_CreateDisplay();
    if (g_NativeDisplay < 0)
    {
        HI3D_TRACE("NATIVE_CreateDisplay failed!\n");
        return -1;
    }

    g_NativeWindow = NATIVE_CreateWindow("egl window", width, height, 0);
...
HI_S32 hi_egl_destroy()
{
    ...
    NATIVE_DestroyWindow(g_NativeWindow);
    NATIVE_DestroyDisplay(g_NativeDisplay);
