...
static HI_DFBINPUT_SCREEN_INFO_S s_ScreenInfo;
...
static DFBInputDeviceTypeFlags DFBINPUT_GetDeviceType(MOUSE_DEVICE_INFO   *devices,
                                               DFBInputDeviceID     device_id );

static HI_VOID                 DFBINPUT_ProcessMouseEvent( DFBInputEvent *evt );
...
/******************************************************************************
func                     : HI_DFBINPUT_GetWindowHandle
...
others                      :nothing
******************************************************************************/
HI_S32 HI_DFBINPUT_GetWindowHandle( IDirectFB              *pdfb,
                                                 IDirectFBWindow        *window,
                                                 DFBWindowID             windowID,
                                                 HI_DFBINPUT_SCREEN_INFO_S             screeninfo,
...
/******************************************************************************
func                     : HI_DFBINPUT_ProcessIInputEvents
description              :
param[in]                :
retval                   :HI_SUCCESS
retval                   :HI_FAILURE
others                      :nothing
******************************************************************************/
static HI_S32 HI_DFBINPUT_ProcessIInputEvents(DFBWindowEvent*    pEvt,
...
others                      :nothing
******************************************************************************/
HI_S32 HI_DFBINPUT_MOUSE_GetKey(HI_VOID)
{
    DFBWindowEvent evt;
    ...
    s32RetVal = HI_DFBINPUT_ProcessIInputEvents(&evt, &pActiveWindow);
...
HI_S32 HI_DFBINPUT_MOUSE_GetKey(HI_VOID)
{
    ...
    if (s_event->GetEvent( s_event, DFB_EVENT(&evt)) == DFB_OK)
    {
        ...
        device_type = DFBINPUT_GetDeviceType( s_devices, evt.device_id );
        ...
        case DIET_AXISMOTION:
            ...
            {
                DFBINPUT_ProcessMouseEvent( &evt );
            }
